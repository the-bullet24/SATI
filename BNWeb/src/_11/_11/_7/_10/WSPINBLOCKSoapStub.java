...
public class WSPINBLOCKSoapStub extends com.ibm.ws.webservices.engine.client.Stub implements _11._11._7._10.WSPINBLOCKSoap {
    public WSPINBLOCKSoapStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws com.ibm.ws.webservices.engine.WebServicesFault {
        if (service == null) {
        ...
        if (theOption == null || !theOption.equals("_11._11._7._10.WSPINBLOCKSoap")) {
                initTypeMapping();
                super._setProperty("lastStubMapping","_11._11._7._10.WSPINBLOCKSoap");
        }
    ...
    private static com.ibm.ws.webservices.engine.description.OperationDesc _getoperacionesPINBLOCKAhorrosOperation0() {
        ...
        _operacionesPINBLOCKAhorrosOperation0 = new com.ibm.ws.webservices.engine.description.OperationDesc("operacionesPINBLOCKAhorros", com.ibm.ws.webservices.engine.utils.QNameTable.createQName("http://10.7.11.11/WSDesaPINBLOCK/WSPINBLOCK", "OperacionesPINBLOCKAhorros"), _params0, _returnDesc0, _faults0, "http://10.7.11.11/WSDesaPINBLOCK/WSPINBLOCK/OperacionesPINBLOCKAhorros");
        _operacionesPINBLOCKAhorrosOperation0.setOption("portTypeQName",com.ibm.ws.webservices.engine.utils.QNameTable.createQName("http://10.7.11.11/WSDesaPINBLOCK/WSPINBLOCK", "WSPINBLOCKSoap"));
        _operacionesPINBLOCKAhorrosOperation0.setOption("outputMessageQName",com.ibm.ws.webservices.engine.utils.QNameTable.createQName("http://10.7.11.11/WSDesaPINBLOCK/WSPINBLOCK", "OperacionesPINBLOCKAhorrosSoapOut"));
        _operacionesPINBLOCKAhorrosOperation0.setOption("ResponseLocalPart","OperacionesPINBLOCKAhorrosResponse");
        _operacionesPINBLOCKAhorrosOperation0.setOption("targetNamespace","http://10.7.11.11/WSDesaPINBLOCK/WSPINBLOCK");
        _operacionesPINBLOCKAhorrosOperation0.setOption("ResponseNamespace","http://10.7.11.11/WSDesaPINBLOCK/WSPINBLOCK");
        _operacionesPINBLOCKAhorrosOperation0.setOption("buildNum","cf192102.03");
        _operacionesPINBLOCKAhorrosOperation0.setOption("inoutOrderingReq","false");
        _operacionesPINBLOCKAhorrosOperation0.setOption("ServiceQName",com.ibm.ws.webservices.engine.utils.QNameTable.createQName("http://10.7.11.11/WSDesaPINBLOCK/WSPINBLOCK", "WSPINBLOCK"));
        _operacionesPINBLOCKAhorrosOperation0.setOption("inputMessageQName",com.ibm.ws.webservices.engine.utils.QNameTable.createQName("http://10.7.11.11/WSDesaPINBLOCK/WSPINBLOCK", "OperacionesPINBLOCKAhorrosSoapIn"));
    ...
    private synchronized com.ibm.ws.webservices.engine.client.Stub.Invoke _getoperacionesPINBLOCKAhorrosInvoke0(Object[] parameters) throws com.ibm.ws.webservices.engine.WebServicesFault  {
        ...
        if (mc == null) {
            ...
            mc.setOperation(WSPINBLOCKSoapStub._operacionesPINBLOCKAhorrosOperation0);
            mc.setUseSOAPAction(true);
            mc.setSOAPActionURI("http://10.7.11.11/WSDesaPINBLOCK/WSPINBLOCK/OperacionesPINBLOCKAhorros");
    ...
    private static com.ibm.ws.webservices.engine.description.OperationDesc _getoperacionesPINBLOCKCtasCtesOperation1() {
        ...
        com.ibm.ws.webservices.engine.description.ParameterDesc  _returnDesc1 = new com.ibm.ws.webservices.engine.description.ParameterDesc(com.ibm.ws.webservices.engine.utils.QNameTable.createQName("http://10.7.11.11/WSDesaPINBLOCK/WSPINBLOCK", "OperacionesPINBLOCKCtasCtesResult"), com.ibm.ws.webservices.engine.description.ParameterDesc.OUT, com.ibm.ws.webservices.engine.utils.QNameTable.createQName("http://www.w3.org/2001/XMLSchema", "string"), java.lang.String.class, true, false, false, true, true, false); 
        ...
        _operacionesPINBLOCKCtasCtesOperation1 = new com.ibm.ws.webservices.engine.description.OperationDesc("operacionesPINBLOCKCtasCtes", com.ibm.ws.webservices.engine.utils.QNameTable.createQName("http://10.7.11.11/WSDesaPINBLOCK/WSPINBLOCK", "OperacionesPINBLOCKCtasCtes"), _params1, _returnDesc1, _faults1, "http://10.7.11.11/WSDesaPINBLOCK/WSPINBLOCK/OperacionesPINBLOCKCtasCtes");
        _operacionesPINBLOCKCtasCtesOperation1.setOption("portTypeQName",com.ibm.ws.webservices.engine.utils.QNameTable.createQName("http://10.7.11.11/WSDesaPINBLOCK/WSPINBLOCK", "WSPINBLOCKSoap"));
        _operacionesPINBLOCKCtasCtesOperation1.setOption("outputMessageQName",com.ibm.ws.webservices.engine.utils.QNameTable.createQName("http://10.7.11.11/WSDesaPINBLOCK/WSPINBLOCK", "OperacionesPINBLOCKCtasCtesSoapOut"));
        _operacionesPINBLOCKCtasCtesOperation1.setOption("ResponseLocalPart","OperacionesPINBLOCKCtasCtesResponse");
        _operacionesPINBLOCKCtasCtesOperation1.setOption("targetNamespace","http://10.7.11.11/WSDesaPINBLOCK/WSPINBLOCK");
        _operacionesPINBLOCKCtasCtesOperation1.setOption("ResponseNamespace","http://10.7.11.11/WSDesaPINBLOCK/WSPINBLOCK");
        _operacionesPINBLOCKCtasCtesOperation1.setOption("buildNum","cf192102.03");
        _operacionesPINBLOCKCtasCtesOperation1.setOption("inoutOrderingReq","false");
        _operacionesPINBLOCKCtasCtesOperation1.setOption("ServiceQName",com.ibm.ws.webservices.engine.utils.QNameTable.createQName("http://10.7.11.11/WSDesaPINBLOCK/WSPINBLOCK", "WSPINBLOCK"));
        _operacionesPINBLOCKCtasCtesOperation1.setOption("inputMessageQName",com.ibm.ws.webservices.engine.utils.QNameTable.createQName("http://10.7.11.11/WSDesaPINBLOCK/WSPINBLOCK", "OperacionesPINBLOCKCtasCtesSoapIn"));
    ...
    private synchronized com.ibm.ws.webservices.engine.client.Stub.Invoke _getoperacionesPINBLOCKCtasCtesInvoke1(Object[] parameters) throws com.ibm.ws.webservices.engine.WebServicesFault  {
        ...
        if (mc == null) {
            mc = new com.ibm.ws.webservices.engine.MessageContext(super.engine);
            mc.setOperation(WSPINBLOCKSoapStub._operacionesPINBLOCKCtasCtesOperation1);
            mc.setUseSOAPAction(true);
            mc.setSOAPActionURI("http://10.7.11.11/WSDesaPINBLOCK/WSPINBLOCK/OperacionesPINBLOCKCtasCtes");
            mc.setEncodingStyle(com.ibm.ws.webservices.engine.Constants.URI_LITERAL_ENC);
            mc.setProperty(com.ibm.wsspi.webservices.Constants.SEND_TYPE_ATTR_PROPERTY, Boolean.FALSE);
            mc.setProperty(com.ibm.wsspi.webservices.Constants.ENGINE_DO_MULTI_REFS_PROPERTY, Boolean.FALSE);
            super.primeMessageContext(mc);
