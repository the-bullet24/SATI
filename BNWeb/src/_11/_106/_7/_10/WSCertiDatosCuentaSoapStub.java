/**
 * WSCertiDatosCuentaSoapStub.java
 *
...
public class WSCertiDatosCuentaSoapStub extends com.ibm.ws.webservices.engine.client.Stub implements _11._106._7._10.WSCertiDatosCuentaSoap {
    public WSCertiDatosCuentaSoapStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws com.ibm.ws.webservices.engine.WebServicesFault {
        if (service == null) {
        ...
        if (theOption == null || !theOption.equals("_11._106._7._10.WSCertiDatosCuentaSoap")) {
                initTypeMapping();
                super._setProperty("lastStubMapping","_11._106._7._10.WSCertiDatosCuentaSoap");
        }
    ...
    private static com.ibm.ws.webservices.engine.description.OperationDesc _getoperacionesDatosCuentaOperation0() {
        ...
        _operacionesDatosCuentaOperation0 = new com.ibm.ws.webservices.engine.description.OperationDesc("operacionesDatosCuenta", com.ibm.ws.webservices.engine.utils.QNameTable.createQName("http://10.7.106.11/WSCertiDatosCuenta/WSCertiDatosCuenta", "OperacionesDatosCuenta"), _params0, _returnDesc0, _faults0, "http://10.7.106.11/WSCertiDatosCuenta/WSCertiDatosCuenta/OperacionesDatosCuenta");
        _operacionesDatosCuentaOperation0.setOption("portTypeQName",com.ibm.ws.webservices.engine.utils.QNameTable.createQName("http://10.7.106.11/WSCertiDatosCuenta/WSCertiDatosCuenta", "WSCertiDatosCuentaSoap"));
        _operacionesDatosCuentaOperation0.setOption("outputMessageQName",com.ibm.ws.webservices.engine.utils.QNameTable.createQName("http://10.7.106.11/WSCertiDatosCuenta/WSCertiDatosCuenta", "OperacionesDatosCuentaSoapOut"));
        _operacionesDatosCuentaOperation0.setOption("ResponseLocalPart","OperacionesDatosCuentaResponse");
        _operacionesDatosCuentaOperation0.setOption("targetNamespace","http://10.7.106.11/WSCertiDatosCuenta/WSCertiDatosCuenta");
        _operacionesDatosCuentaOperation0.setOption("ResponseNamespace","http://10.7.106.11/WSCertiDatosCuenta/WSCertiDatosCuenta");
        _operacionesDatosCuentaOperation0.setOption("buildNum","cf192102.03");
        _operacionesDatosCuentaOperation0.setOption("inoutOrderingReq","false");
        _operacionesDatosCuentaOperation0.setOption("ServiceQName",com.ibm.ws.webservices.engine.utils.QNameTable.createQName("http://10.7.106.11/WSCertiDatosCuenta/WSCertiDatosCuenta", "WSCertiDatosCuenta"));
        _operacionesDatosCuentaOperation0.setOption("inputMessageQName",com.ibm.ws.webservices.engine.utils.QNameTable.createQName("http://10.7.106.11/WSCertiDatosCuenta/WSCertiDatosCuenta", "OperacionesDatosCuentaSoapIn"));
    ...
    private synchronized com.ibm.ws.webservices.engine.client.Stub.Invoke _getoperacionesDatosCuentaInvoke0(Object[] parameters) throws com.ibm.ws.webservices.engine.WebServicesFault  {
        ...
        if (mc == null) {
            ...
            mc.setOperation(WSCertiDatosCuentaSoapStub._operacionesDatosCuentaOperation0);
            mc.setUseSOAPAction(true);
            mc.setSOAPActionURI("http://10.7.106.11/WSCertiDatosCuenta/WSCertiDatosCuenta/OperacionesDatosCuenta");
