...
public class RptaListaEnvioSmss_Ser extends com.ibm.ws.webservices.engine.encoding.ser.BeanSerializer {
    /**
     * Constructor
     */
    public RptaListaEnvioSmss_Ser(
    ...
    protected void addElements(
        ...
        throws java.io.IOException
    {
        RptaListaEnvioSmss bean = (RptaListaEnvioSmss) value;
        ...
        javax.xml.namespace.QName propQName;
        {
          ...
          propValue = bean.getCodDetalleReq();
          if (propValue != null && !context.shouldSendXSIType()) {
            context.simpleElement(propQName, null, propValue.toString()); 
          } else {
            serializeChild(propQName, null, 
