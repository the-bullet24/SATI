...
public class ValidarTDCResponse  extends com.novatronic.ws.BaseResponse  implements java.io.Serializable {
    public ValidarTDCResponse() {
    }
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ValidarTDCResponse)) return false;
        ValidarTDCResponse other = (ValidarTDCResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ValidarTDCResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://ws.novatronic.com/", "validarTDCResponse"));
    }
