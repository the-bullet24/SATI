...
public class ValidarImagenResponse  extends com.novatronic.ws.BaseResponse  implements java.io.Serializable {
    public ValidarImagenResponse() {
    }
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ValidarImagenResponse)) return false;
        ValidarImagenResponse other = (ValidarImagenResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ValidarImagenResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://ws.novatronic.com/", "validarImagenResponse"));
    }
