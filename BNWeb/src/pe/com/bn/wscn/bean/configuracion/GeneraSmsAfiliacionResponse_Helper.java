/**
 * GeneraSmsAfiliacionResponse_Helper.java
 *
...
public class GeneraSmsAfiliacionResponse_Helper {
    // Type metadata
    private static final com.ibm.ws.webservices.engine.description.TypeDesc typeDesc =
        new com.ibm.ws.webservices.engine.description.TypeDesc(GeneraSmsAfiliacionResponse.class);
    ...
    static {
        ...
        field.setXmlType(com.ibm.ws.webservices.engine.utils.QNameTable.createQName("http://configuracion.bean.wscn.bn.com.pe", "DataSms"));
        typeDesc.addFieldDesc(field);
        field = new com.ibm.ws.webservices.engine.description.ElementDesc();
    ...
    public static com.ibm.ws.webservices.engine.encoding.Serializer getSerializer(
        ...
        return 
          new GeneraSmsAfiliacionResponse_Ser(
    ...
    public static com.ibm.ws.webservices.engine.encoding.Deserializer getDeserializer(
           ...
           javax.xml.namespace.QName xmlType) {
        return 
          new GeneraSmsAfiliacionResponse_Deser(
            javaType, xmlType, typeDesc);
    };
