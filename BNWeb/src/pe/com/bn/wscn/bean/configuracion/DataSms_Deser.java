...
public class DataSms_Deser extends com.ibm.ws.webservices.engine.encoding.ser.BeanDeserializer {
    /**
     * Constructor
     */
    public DataSms_Deser(
    ...
    protected boolean tryElementSetFromString(javax.xml.namespace.QName qName, java.lang.String strValue) {
        if (qName==QName_0_30) {
          ((DataSms)value).setCodeSMS(strValue);
          return true;}
        else if (qName==QName_0_31) {
          ((DataSms)value).setFecha(strValue);
          return true;}
        else if (qName==QName_0_32) {
          ((DataSms)value).setNumOperacion(strValue);
          return true;}
        return false;
    }
