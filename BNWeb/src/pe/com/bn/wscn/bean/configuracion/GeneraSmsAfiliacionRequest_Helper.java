/**
 * GeneraSmsAfiliacionRequest_Helper.java
 *
...
public class GeneraSmsAfiliacionRequest_Helper {
    // Type metadata
    private static final com.ibm.ws.webservices.engine.description.TypeDesc typeDesc =
        new com.ibm.ws.webservices.engine.description.TypeDesc(GeneraSmsAfiliacionRequest.class);

    static {
        typeDesc.setOption("buildNum","cf222226.01");
        com.ibm.ws.webservices.engine.description.FieldDesc field = new com.ibm.ws.webservices.engine.description.ElementDesc();
        field.setFieldName("codCanal");
        field.setXmlName(com.ibm.ws.webservices.engine.utils.QNameTable.createQName("", "codCanal"));
    ...
    public static com.ibm.ws.webservices.engine.encoding.Serializer getSerializer(
        ...
        return 
          new GeneraSmsAfiliacionRequest_Ser(
    ...
    public static com.ibm.ws.webservices.engine.encoding.Deserializer getDeserializer(
           ...
           javax.xml.namespace.QName xmlType) {
        return 
          new GeneraSmsAfiliacionRequest_Deser(
            javaType, xmlType, typeDesc);
    };
