/**
 * MotivoDesafilaicionResponse_Ser.java
 *
...
public class MotivoDesafilaicionResponse_Ser extends com.ibm.ws.webservices.engine.encoding.ser.BeanSerializer {
    /**
     * Constructor
     */
    public MotivoDesafilaicionResponse_Ser(
    ...
    protected void addElements(
        ...
        throws java.io.IOException
    {
        MotivoDesafilaicionResponse bean = (MotivoDesafilaicionResponse) value;
        java.lang.Object propValue;
        javax.xml.namespace.QName propQName;
        {
          propQName = QName_0_25;
          propValue = bean.getCodResult();
          ...
          propValue = bean.getMotivos();
          serializeChild(propQName, null, 
              propValue, 
              QName_5_59,
              true,null,context);
          propQName = QName_0_27;
          propValue = bean.getMsg();
          if (propValue != null && !context.shouldSendXSIType()) {
            context.simpleElement(propQName, null, propValue.toString()); 
          } else {
            serializeChild(propQName, null, 
    ...
    private final static javax.xml.namespace.QName QName_0_25 = 
           com.ibm.ws.webservices.engine.utils.QNameTable.createQName(
                  "",
                  "codResult");
    private final static javax.xml.namespace.QName QName_5_59 = 
           com.ibm.ws.webservices.engine.utils.QNameTable.createQName(
                  "http://interoperabilidad.bean.wscn.bn.com.pe",
                  "ArrayOfMotivo");
