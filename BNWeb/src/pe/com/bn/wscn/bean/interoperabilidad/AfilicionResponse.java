...
public class AfilicionResponse  {
    private java.lang.String codResult;
    private pe.com.bn.wscn.bean.interoperabilidad.Afiliacion data;
    private java.lang.String msg;
    private java.lang.String msgError;

    public AfilicionResponse() {
    }
    ...
    public pe.com.bn.wscn.bean.interoperabilidad.Afiliacion getData() {
        return data;
    }

    public void setData(pe.com.bn.wscn.bean.interoperabilidad.Afiliacion data) {
        this.data = data;
    }
