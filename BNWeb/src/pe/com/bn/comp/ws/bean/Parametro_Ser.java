...
public class Parametro_Ser extends com.ibm.ws.webservices.engine.encoding.ser.BeanSerializer {
    /**
     * Constructor
     */
    public Parametro_Ser(
    ...
    protected void addElements(
        ...
        throws java.io.IOException
    {
        Parametro bean = (Parametro) value;
        java.lang.Object propValue;
        javax.xml.namespace.QName propQName;
        {
          propQName = QName_0_6;
          propValue = bean.getAliasParam();
          ...
          propQName = QName_0_8;
          propValue = bean.getDescripcionParam();
          if (propValue != null && !context.shouldSendXSIType()) {
            context.simpleElement(propQName, null, propValue.toString()); 
          } else {
            serializeChild(propQName, null, 
