 ...
 */
public class ServletAfiliacionInternet extends HttpServlet {
	private static LoggerSati log3 = LoggerSati.getInstance(ServletAfiliacionInternet.class.getName());
	...
	throws ServletException, IOException {
		...
		getServletContext().getRequestDispatcher("/WEB-INF/page/sistema/inicioAfiliacionInternet.jsp").forward(req,resp);
		//
	}
