...
public class DesafTelefoniaAction extends GrandActionAbstract {
	private static LoggerSati log3 = LoggerSati.getInstance(DesafTelefoniaAction.class.getName());
	...
	throws Exception {
		...
		request.getSession().setAttribute(ConstanteSesion.DES_SUBTITULO2,"Nro. de Servicio");
		    ...
		    path = request.getContextPath()+"/pagoTelefono.do?hidServicio=1";
