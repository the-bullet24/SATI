...
public class DesafTarjetaLineaAction extends GrandActionAbstract {
	private static LoggerSati log3 = LoggerSati.getInstance(DesafTarjetaLineaAction.class.getName());
	...
	throws Exception {
		...
		request.getSession().setAttribute(ConstanteSesion.DES_SUBTITULO2,"Nro. de Servicio");
		    ...
		    ConstanteSesion.TITULO = "DESAFILIACION TARJETAS DE CREDITO EN LINEA DE OTROS BANCOS";
			request.getSession().setAttribute("TITULO","DESAFILIACION TARJETAS DE CREDITO EN LINEA DE OTROS BANCOS");
			...
			listaDesafiliacion =  FacadeFactory.getAfiliacionFacade().getAfiliaciones(Constante.PAGO_TARJETA_LINEA,usuario.getTarjeta().getNumero(), "00420");
