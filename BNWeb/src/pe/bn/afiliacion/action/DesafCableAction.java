...
import pe.bn.cldinamica.action.ClaveDinamicaAction;
...
public class DesafCableAction extends GrandActionAbstract {
	private static LoggerSati log3 = LoggerSati.getInstance(DesafCableAction.class.getName());
	...
	throws Exception {
		...
		request.getSession().setAttribute(ConstanteSesion.DES_SUBTITULO2,"Nro. de Servicio");
		    ...
		    path = request.getContextPath()+"/pagoTelefono.do?hidServicio=7";
