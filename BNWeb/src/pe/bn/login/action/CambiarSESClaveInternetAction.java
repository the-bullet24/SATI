...
public class CambiarSESClaveInternetAction extends GrandActionAbstract{
	private static LoggerSati log3 = LoggerSati.getInstance(CambiarSESClaveInternetAction.class.getName());
