...
// ---- Common Options ----
var gMonths=["Enero","Febrero","Marzo","Abril","Mayo","Junio","Julio","Agosto","Setiembre","Octubre","Noviembre","Diciembre"];
...
var gcCalBG="#C44141";	// the background color of the outer calendar panel.
var guCalBG=null;	//  the background image url for the inner table.
var gcCalFrame="#C51416";	// the background color of the inner table, showing as a frame.
...
var gsBottom="<A href='javascript:void(0)' class='BottomAnchor' onclick='if(this.blur)this.blur();if(!fSetDate(gToday[0],gToday[1],gToday[2]))alert(\"You cannot select today!\");return false;' onmouseover='return true;' >Hoy : "+gMonths[gToday[1]-1]+" "+gToday[2]+", de "+gToday[0]+"</A>";	// the content of the bottom section.
...
var gcCellBG="#eeeeee";	// default background color of the cells. Use "" for transparent!!!
...
var gcToggle="#FFF";	// the highlight color for the focused cell
