...
<card id="tar12"  >
    ...
    <do type="accept" label="OK">
	  <go href="<%= request.getContextPath().trim() %>/ServletCCIAhorros" method="post">
...
<card id="tar8"  newcontext="true">
	...
	<input type="text" format="NNN" name="cvv2" size="4" maxlength="4" /></p>
