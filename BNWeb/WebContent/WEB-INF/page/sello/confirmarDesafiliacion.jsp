...
<body oncontextmenu="return false" onselectstart="return false" ondragstart="return false" onload="return cerrar()" onKeyDown="return cancelRefresh(event)">
					...
					<TABLE width="425" border="1" cellspacing="1" bordercolor="#FFCC00" bgcolor="#FFFFFF">
						<TR>
							<TD align="center" bgcolor="#FFCC00" class="texto">
								<DIV align="center"><b><SPAN class="texto"><c:out value='${msgSello9}' escapeXml="false" /></SPAN></b></DIV>
							</TD>
						</TR>
					</TABLE>
