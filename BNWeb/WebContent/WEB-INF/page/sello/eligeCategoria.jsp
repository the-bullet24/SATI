...
<table width="100" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#E1E1E1">
	...
	<td>
		<table width="900"  border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#E22028">
			<tr>
				<td height="1" colspan="3" bgcolor="#FFFFFF"><h1 class="ti0">Seleccione la imagen que Ud. configuro</h1></td>
			</tr>
			<tr>
				...
				<td width="500">
					...
					<TABLE width="425" border="1" cellspacing="1" bordercolor="#FFCC00" bgcolor="#FFFFFF">
						<TR>
							<TD align="center" bgcolor="#FFCC00" class="texto">
								<DIV align="center"><b><SPAN class="texto"><c:out value='${msgSello4}' escapeXml="false" /></SPAN></b></DIV>
							</TD>
						</TR>
					</TABLE>
					<TABLE width="425" border="1" cellspacing="1" bordercolor="#FFCC00" bgcolor="#FFFFFF">
						<tr>
							<td>
							<center> 
								<select name="cboCategoria" style="textizq8">
					...
					<div >
						<center><input type="button" value="Continuar" onClick="javascript:autenticar();"/> <center> 
					</div>
