...
<link rel="stylesheet" type="text/css"
	href="<%=request.getContextPath()%>/css/resetearcss.css" />
<link rel="stylesheet" type="text/css"
	href="<%=request.getContextPath()%>/css/tipografias.css" />
<link rel="stylesheet" type="text/css"
	href="<%=request.getContextPath()%>/css/bn-estilos.css" />
...
<SCRIPT language="javascript"><!--
	...
	function continuar(){		
		...
		form.metodo.value  = 'constanciaCambio';			
...
<body oncontextmenu="return false" onselectstart="return false"
	...
	<form name="frmVerificarCambio" method="post">
		<input type="hidden" name="transaccion" value="TL01"> <input
			type="hidden" name="metodo"> <input type="hidden"
			name="idObjeto"> <input type="hidden" name="variableSesion">
		...
		<div id="contenidos-informativos">
			...
			<div style="LINE-HEIGHT: 30px;">
				...
				<c:if test="${tipoElemento.tipoElementoSeguridad=='5'}">
					<span style="width: 230px; font-family: Arial; font-size: 14px;">
						Para confirmar tu cambio de celular, ingresa tu clave TOKEN de 6
						digitos. </span>
				</c:if>

				<c:if test="${tipoElemento.tipoElementoSeguridad=='6'}">
					<span style="width: 230px; font-family: Arial; font-size: 14px;">
						Para confirmar tu cambio de celular, ingresa tu Clave Dinámica
						Digital. </span>
				</c:if>
				<!-- Para realizar la actualización de número de celular en transferencia por contacto, por favor ingrese el código para su confirmación.	 -->

			</div>
			</br> </br>
			<div class="fila limpiar">
				<label for="lblCPersonal">N&uacute;mero Celular personal a
					Afiliar:</label> <label type="label" style="padding-left: 99px;"
			...
			<div class="fila limpiar">
				<label for="cmbCue">Nro Cuenta a afiliar:</label>
				<TABLE class="RESULTADO"
					style="padding-left: 94px; color: #808080; font-family: Arial Narrow; font-size: 12px;">
					<tr>
						<TD></TD>
			...
			<div class="fila limpiar">
				<label for="lblFecha">Nro. CCI:</label> <label type="label"
					style="padding-left: 99px;" name="lblFechaEmi" id="lblFechaEmi" />
				<bean:write
					name="<%=pe.cosapi.common.ConstanteSesion.USUARIO_EN_SESION%>"
					property="cciCliente" />
				</label>
			...
			<div style="width: auto;">
				...
				<TABLE cellspacing="0" width="100%">
					...
					<c:if test="${tipoElemento.tipoElementoSeguridad=='5'}">
						...
						<TR>
							<td class="ingreso" colspan="2"><%@ page
									import="java.util.Map"%> <%@ page
									import="pe.cosapi.system.TecladoUtil"%> <%@ page
								...
								%>
								<div class="fila limpiar">
									<label for="clave" style="width: 140px;">Utilice el
										teclado virtual para ingresar el Token:</label>
									...
									<input type="hidden" value="<%=teclado.getRandomEncript()%>"
										name="hdnValue">
							...
							<td class="ingreso" colspan="2"><img border="0"
								src="<%=request.getContextPath()%>/imagenes/bn/toke.jpg"
								style="float: left;" />
								<div id="campo-clave">
									<p style="width: 124px;">Ingresar los 6 d&iacute;gitos del
										TOKEN</p>
							...
							<table>
								...
								<tr>
									<td class="iz" colspan="4">
										...
										<div class="tooltip">
											<u
												style="color: #273C4E; cursor: pointer; font-family: Arial Narrow; font-size: 13px; font-weight: bold;">
												&#191;Nunca lleg&oacute; el C&oacute;digo&#63; <img
												border="0"
												src="<%=request.getContextPath()%>/imagenes/bn/ios_icon_info_blue28x28.png"
												style="float: right; margin-top: -3px;" width="18px"
												height="18px">
											</u>
										</div>
									</td>
					...
					<c:if test="${tipoElemento.tipoElementoSeguridad=='2'}">
						<TR>
							<TD colspan="3" class="ingreso" style="width: 592px;"><p>
									<u>Ejemplo:</u> <br> Al solicitarle la coordenada <B>6
										- F</B>, deber&aacute;s buscar la fila correspondiente al <b>n&uacute;mero
										6</b> y la columna de la <B>letra F</B>, en la uni&oacute;n de
									ambos, obtendr&aacute;s un n&uacute;mero, &eacute;ste
									n&uacute;mero deber&aacute;s ingresarlo para aprobar la
									operaci&oacute;n.
								</p></TD>
...
<div id="contenidos-informativos">
			...
			<div style="text-align: center; margin-top: 20px;">
				<input type="checkbox" name="chkAceptar" id="chkAceptar" value="S" class="textizqn" /><span class="span">Acepto	t&eacute;rminos y condiciones</span>
			</div>
