					...
					<td width="100%">
						...
						<tr>
								<td colspan="6">
										...
										¡Felicidades! Tiene un préstamo pre aprobado de S/ <bean:write name="<%=pe.cosapi.common.ConstanteSesion.USUARIO_EN_SESION%>" property="montoMaxPrestamo" /> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
												<div class="boton2">
													<input style="float: right;margin: -17px auto;" type="button" value="Pidelo Aquí" id="boton" onclick="javascript:simular();"/>		
												</div>
						...
						<c:if test="${indPrestamo==false}">
										...
										<tr>
											<td colspan="5" align="center" class="texto" height="26"><p align=justify style="color: #c51416 !important;">Estimado cliente, para conocer si tenemos ofertas para usted visite nuestra agencia más cercana o consulte 
