...
<input type="hidden" name="flag">
	...
	<div id="contenidos-informativos">
		...
		<br/>
		  <div class="formEstandar">
		  		<label for="cliente" class="cerrar" ><label style="width: 640px !important;">

<br/>
Para conocer si tenemos ofertas para usted visite nuestra agencia más cercana o consulte
