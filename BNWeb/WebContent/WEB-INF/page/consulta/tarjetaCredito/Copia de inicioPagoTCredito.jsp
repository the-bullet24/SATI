...
<body onselectstart="return false" ondragstart="return false" oncontextmenu="return false"  onkeydown="return cancelRefresh(event);">
	...
	<div class="fila limpiar">
       <label for="lnrotc">Nro. Tarjeta de Crédito: </label>
	...
	<div class="fila limpiar">
       <label for="lmin">Pago Mínimo: </label>
   	...
   	<div class="fila limpiar">
       <label for="ltot">Pago Total: </label>
       <label for="tot" style="text-align: left;">S/ <bean:write name="<%=pe.cosapi.common.ConstanteSesion.CONSULTA%>" property="montoPagoFacturacion" ignore="true"/></label>
   	</div>
