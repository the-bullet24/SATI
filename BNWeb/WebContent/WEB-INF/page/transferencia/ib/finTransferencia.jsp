...
<script language="javascript">
	...
	function imprimir(){
		window.open('<%=request.getContextPath()%>/util.do?metodo=solicitarRefrendo&variableSesion=<%=pe.cosapi.common.ConstanteSesion.TRANSFERENCIA%>&idObjeto=refrendoTransferenciaInterbancariaMTOT',"BN","toolbar=0,location=0,width=600,height=560, scrollbars=no, resizable=yes,  top=" + ((screen.height/2)-(650/2))+", left="+((screen.width/2)-(450/2)));
	}

	function enviar(){
		window.open('<%=request.getContextPath()%>/util.do?metodo=verMail&variableSesion=<%=pe.cosapi.common.ConstanteSesion.TRANSFERENCIA%>&idObjeto=mailTransferenciaInterbancariaMTOT',"Mail","toolbar=0,location=0,width=600,height=700, scrollbars=no, resizable=yes,  top=" + ((screen.height/2)-(600/2))+", left="+((screen.width/2)-(500/2)));
	}
	...
	function verPdf(){
		...
		form.idObjeto.value = 'refrendoTransferenciaInterbancariaMTOT';
		form.variableSesion.value = '<%=pe.cosapi.common.ConstanteSesion.TRANSFERENCIA%>';
		form.titulo.value = 'TRANSFERENCIA INTERBANCARIA';
...
<form name="frmTransferenciaIB" method="post">
	...
	<div id="contenidos-informativos">
		...
		<caption class="titulo-constancia">
			CONSTANCIA DE TRANSFERENCIAS INTERBANCARIAS
	    </caption>
	    <tbody>
    	<tr>
