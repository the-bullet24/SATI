...
<script language="javascript">
	function transferir(){
		...
		form.action="<%=request.getContextPath()%>/transferenciaInterbancaria.do?metodo=transferir";
		form.submit();
	...
	function regresar(){
		var form = document.frmTransferenciaIB;
		form.action="<%=request.getContextPath()%>/transferenciaInterbancaria.do?metodo=iniciar";
		form.submit();
	}
...
$('.tooltip').click(function() {
 ...
 function evalRanTable(valor){
	...
	function generarClaveSms(e){		
	    ...
	    xmlhttp.open("POST", '<%=request.getContextPath()%>/transferenciaInterbancaria.do?metodo=reGenerarClaveSms&txtMonto='+monto, true);
	    xmlhttp.send();
	    }
	}
...
<form name="frmTransferenciaIB" method="post">
	...
	<input type="hidden" name="txtNombreBenef" value="<bean:write name="txtNombreBenef"/>"/>
	...
	<input type="hidden" name="txtMonto" id="txtMonto"			value='<bean:write name="txtMonto"/>'/>
		...
		<div style="width:auto;">
			...
			<tr>
       		...
       		<tr>
       			...
       			<td class="der" ><label style="margin-left:20px; font-family:Arial ; ">
       		...
       		<tr>
       			...
       			<td class="der" style="text-align:right;">
			...
			<tr>
				...
				<td class="der" style="text-align:right;">
				<label style="margin-left:20px; font-family:Arial; width:337px;text-align: right;">
				<bean:write name="cuenta"
							property="simboloMonedaProducto" />
					<bean:write name="transferencia" property="importe"  />
					</label>
					</td>
			</tr>
			...
			<tr>
				...
				<td class="der" style="text-align:right;">
				<label style="margin-left:20px; font-family:Arial; width:337px;text-align: right;">
				<bean:write name="cuenta" property="simboloMonedaProducto" />&nbsp;<bean:write name="transferencia" property="importe"  />
				</label>
				</td>
			</tr>
			</logic:equal>
			...
			<logic:equal name="afiliacion"  property="cuentaPropia" value="N">
			<tr>
			...
			<tr>
       		...
       		<tr>
       			<td class="iz"><label class="clavesms">Importe a transferir:</label></td>
       			<td class="der" style="text-align:right;">
				<label style="margin-left:20px; font-family:Arial; width:280px;text-align: right;">
       			<bean:write	name="transferencia" property="simboloMonedaImporte" />&nbsp;<bean:write name="txtMonto"/>
       			</label>
       			</td>
       		</tr>
			...
			<tr>
				<td colspan="3"><label class="clavesms">¿Desea adicionar como frecuente?</label>
