...
<script language="javascript">
	...
	*/
	function cleanPass(){
		...
		form.action="<%=request.getContextPath()%>/loginOlvido.do";
        ...
        <div id="cabecera">
            ...
            <div id="login">
                ...
                <div id="login-contenido">
					...
					<p>Ingrese su nueva clave de internet y la confirmacion de la clave de internet usando el teclado virtual.</p>
					</div>
					...
					<div class="formClaveInternetAfil">
							<div class="izq">
								...
								<input type="radio" id="btnClave2" name="btnClave" onclick="deshabilitar(txtClaveInternet)" checked="checked"/>
