...
<script language="javascript">
	...
	*/
	function cleanPass(){
		...
		form.action="<%=request.getContextPath()%>/loginAfiliacion.do";
        ...
        <div id="cabecera">
            ...
            <div id="login">
                ...
                <div id="login-contenido">
					...
					<p>Ingrese su nueva clave de internet y la confirmación de la clave de internet usando el teclado virtual.</p>
					</div>
					...
					<div class="formClaveInternetAfil">
							<div class="izq">
								...
								<label style="width: 165px;">Nueva clave internet:</label>
								...
								<br/>
								<label style="width: 165px;">Confirmación clave internet:</label>
