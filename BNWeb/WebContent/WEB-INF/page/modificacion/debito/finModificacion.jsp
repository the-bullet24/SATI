...
<div id="contenidos-informativos">
	...
	<p class="mensaje">${mensajecabeceraafmb}</p>
		...
		<TABLE class="constancia">
								...
								<TR>
								<TD colspan="3" align="center" height="76" style="width:592px;color:#c51416;"><span class="textizqn"> <B>SE CONFIRMARÁ SU MODIFICACIÓN DE MONTO
									SEGUN LA VIA DE CONFIRMACIÓN ELEGIDA</B></span><BR>
									</td>
								</TR>
