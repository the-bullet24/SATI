...
<SCRIPT language="javascript">
	...
	function regresar(){
		...
		frmAfilDebito.action = "<%=request.getContextPath()%>/AfilDebitoAutomatico.do?metodo=consultaModificacion";
		frmAfilDebito.submit();	
	}
...
<div id="contenidos-informativos">
	...
	<div id="consulta-datos">
	    ...
	    <div class="fila limpiar">
		   	...
		   	<label style="text-align:left;"><c:out value="${modifDA.numSuministro}"/></label>
	   	</div>
	   	<div class="fila limpiar">
		   	<label style="text-align:left;width:300px;">Servicio:</label>
		   	<label style="text-align:left;"><c:out value="${modifDA.servicioMostrar}"/></label>
		</div>
		<div class="fila limpiar">
		   	<label style="text-align:left;width:300px;">Empresa:</label>
		   	<label style="text-align:left;"><c:out value="${modifDA.empresaMostrar}"/></label>
		</div>
		<div class="fila limpiar">
		   	<label style="text-align:left;width:300px;">Monto Máximo:</label>
		   	<label style="text-align:left;"><c:out value="${modifDA.montoMaxMostrar}"/></label>
		</div>
	  	<div class="sub-titulo">
		...
		<div class="fila limpiar">
		   	...
		   	<html:text property="txtMail"  maxlength="30"  styleClass="input-grande"/>
		</div>
		<div class="fila limpiar">
		...
		<div class="fila limpiar">
		   	...
		   	<div id="Op2" style="display:none;">	<html:select property="cmbDiscado" styleClass="select select-grande">
				...
				<html:text property="txtNumeroTelefono" styleClass="input-chico" maxlength="9" onkeypress="return soloNumerosAll(event)"/>
		</div>
		<div class="fila limpiar">
		...
		<div class="fila limpiar">
		   	<label style="text-align:left;width:300px;">&nbsp;</label>					
		</div>
		<c:if test="${tipoElemento.tipoElementoSeguridad=='2'}">
		<div class="fila limpiar">
		   	<label style="text-align:left;width:300px;">Ingresar la Siguiente Coordenada</label>					
		...
		<div class="fila limpiar">
		   	<label style="text-align:left;width:300px;">Ingresar los 6 dígitos del TOKEN</label>					
			<input type="password" name="txtCoordenada" class="input-chico" size="10" maxlength="6"  onkeypress="return soloNumerosAll(event)"/><img border="0" src="<%=request.getContextPath()%>/imagenes/bn/toke.jpg"/>
		</div>
		</c:if>
		...
		<div class="fila limpiar">
			...
			6</b> y la columna de la <B>letra  F</B>, en la unión de ambos, obtendrás un número, éste número deberás ingresarlo para aprobar la operación.</p>
		</div>
		</c:if>
		<c:if test="${tipoElemento.tipoElementoSeguridad=='5'}">
		<div class="fila limpiar">
...
<span style="line-height:17px;font-weight:bold;color:#000000;">
	...
	<div id="botones" class="boton">
		         ...
		         <input type="button" onclick="javascript:modificar();" id="boton" value="MODIFICAR"/>
		    </div>	
	<br/>
