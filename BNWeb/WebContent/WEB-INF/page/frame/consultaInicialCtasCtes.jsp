					...
					<td width="100%">
						...
						<tbody>
							...
							<tr>
								...
								<td width="20%" align="center" class="detalleCelda"><strong><input type="text" class="input-chico" name="txtNumeroCuenta" size="11" maxlength="11" onkeypress="return soloNumerosAll(event)"/> </strong></td>
								<td width="30%" class="detalleCelda"><strong>
						...
						<tr>
							...
							<logic:messagesPresent>
								<div class="cysErrorMsg">
																...
																<label for="numero"><html:errors /></label>
