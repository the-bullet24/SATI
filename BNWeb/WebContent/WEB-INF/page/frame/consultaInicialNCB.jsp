					...
					<td width="100%">
						...
						<tr>
							...
							<td class="detalleCelda"><select title="Tipo de Consulta" name="cbOpciones<%=idx++%>" id="cbOpciones"  class="select select-chico2"  onchange="consultarTarjCred(this,'<bean:write name="cuentaConsulta" property="numeroProducto"/>')">
									...
									<option value="100">Pagar Tarjeta</option>
						...
						<tr>
							<td width="25%" align="center" class="tituloCelda" colspan="2"><strong>Acuerdo</strong></td>
							
							<td width="20%" align="center" class="tituloCelda"><strong>Moneda</strong></td>
						...
						<tr>
							<td class="detalleCelda" colspan="2">&nbsp;<bean:write name="cuentaConsulta" property="cuentaFormateada" /></td>
