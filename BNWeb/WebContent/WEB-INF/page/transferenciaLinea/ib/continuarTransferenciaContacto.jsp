...
<script language="javascript">
	function transferir(){
		...
		form.action="<%=request.getContextPath()%>/transferenciaInterbancariaLinea.do?metodo=transferirContacto";
		form.submit();
...
<form name="frmTransferenciaIB" method="post">
	...
	<input type="hidden" name="txtCuentaCCI" value="<bean:write name="afiliacion" property="numeroServicio"/>"/>
	...
	<div id="contenidos-informativos">
		...
		<div style="width:auto;">
        	...
        	<tr>
       		...
       		<tr>
        		<td class="iz"><label class="clavesms">Nro. Celular de Cuenta Destino: </label></td>
        		<td class="der" colspan="3">
       		...
       		<tr>
       			...
       			<td class="der" colspan="3">
					<label style="margin-left:20px; font-family:Arial; ">       			
       				<bean:write name="transferencia" property="entidadDesc"/>
       				</label>
       			</td>
       		</tr>
       		<tr>
