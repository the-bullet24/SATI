...
onkeydown="return cancelRefresh(event);">
  ...
  <div class="header">
    <img
      class="OkLogo"
      src="<%=request.getContextPath()%>/imagenes/verTransferenciaContacto/Imgs/CheckLogo.png"
      alt=""
    />
    ...
    <p id="HeaderSubTitle" style="font-family: 'daxcompact-mediumregular'">
      La afiliaci&oacute;n fue realizada con &eacute;xito
    </p>
  </div>

  <div id="container">
  
  <h2 id="Title">N&uacute;mero de celular</h2>
  <p id="Number">980 287 644</p>
    ...
    <table>
      ...
      <tr style="padding-bottom: 8px">
        ...
        <td style="padding-bottom: 8px" class="left">
          <img src="/BNWeb/imagenes/verTransferenciaContacto/Imgs/bnlogo.png" />
          Banco de la Naci&oacute;n
        </td>
      </tr>

      <tr style="padding-bottom: 8px">
        <td style="padding-bottom: 8px" class="right">
  ...
  <div class="thanks">
    <p style="font-family: 'daxcompact-mediumregular'">
      ...
      Ahora recibir&aacute;s las transferencias de otros bancos a trav&eacute;s
      de tu nuevo n&uacute;mero de celular.
    </p>
  </div>
  ...
  <div class="Btnscontainer">
    <div class="btns">
      <button>
        <img
          src="<%=request.getContextPath()%>/imagenes/verTransferenciaContacto/Imgs/Vector-4.png"
          alt=""
        />IMPRIMIR
      </button>
      ...
      <button>
        <img
          src="<%=request.getContextPath()%>/imagenes/verTransferenciaContacto/Imgs/Vector-3.png"
          alt=""
        />ENVIAR
      </button>
      ...
      <button>
        <img
          src="<%=request.getContextPath()%>/imagenes/verTransferenciaContacto/Imgs/Vector-5.png"
          alt=""
        />DESCARGAR
      </button>
    </div>
