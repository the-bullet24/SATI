...
<script language="javascript">
	...
	function actualizar(){
		...
		var form = document.forms[0];
		frmDatosClientes.validar.value  = false;
		frmDatosClientes.metodo.value  = 'guardarDireccion';
	...
	function tipoDomicilio(){
		...
		if('<c:out value="${tipoDomicilio.cbxTipoDomicilioHabitual}"/>' == 'S'){
	
		frmDatosClientes.cbxTipoDomicilioHabitual.disabled=false;
		frmDatosClientes.cbxTipoDomicilioHabitual.checked = true;
		frmDatosClientes.cbxTipoDomicilioHabitual.disabled=true;
		}else{frmDatosClientes.cbxTipoDomicilioHabitual.checked = false;}
		if('<c:out value="${tipoDomicilio.cbxTipoDomicilioFiscal}"/>' == 'S'){
		frmDatosClientes.cbxTipoDomicilioFiscal.disabled=false;
		frmDatosClientes.cbxTipoDomicilioFiscal.checked = true;
		frmDatosClientes.cbxTipoDomicilioFiscal.disabled=true;
		}else{frmDatosClientes.cbxTipoDomicilioFiscal.checked = false;}
		if('<c:out value="${tipoDomicilio.cbxTipoDomicilioPostal}"/>' == 'S'){
		
		frmDatosClientes.cbxTipoDomicilioPostal.disabled=false;
		frmDatosClientes.cbxTipoDomicilioPostal.checked = true;
		frmDatosClientes.cbxTipoDomicilioPostal.disabled=true;
...
<body oncontextmenu="return false" onselectstart="return false" ondragstart="return false"  onKeyDown="return cancelRefresh(event)" onload="tipoDomicilio()">
<html:form type="pe.bn.afiliacion.action.form.AfiliacionDatosClientesForm" action="/AfilDatosClientes.do" method="POST" >
<input type="hidden" name="metodo" value="guardarDireccion"/>
...
<input type="hidden" name="codCliente" value="<bean:write name='codCliente'  ignore='true'/>"/>
	...
	<div id="contenidos-informativos" >
		<h2>ACTUALIZACION DE DATOS DEL DOMICILIO</h2>
	...
	<div class="clear cincopx"></div>
		<div class="formEstandar">
			...
			<div class="der" style="font: 13px/23px arial;" >
				<html:checkbox property="cbxTipoDomicilioHabitual" styleId="cbxTipoDomicilioHabitual" disabled="true" >Principal&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</html:checkbox> 
				<html:checkbox property="cbxTipoDomicilioFiscal" styleId="cbxTipoDomicilioFiscal"  disabled="true" >Fiscal&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</html:checkbox>
				<html:checkbox property="cbxTipoDomicilioPostal" styleId="cbxTipoDomicilioPostal"  disabled="true" >Correspondencia</html:checkbox>
			...
			<div id="noResidente" style="display: none;">
				<div class="izq"  style="width: 150px ! important;">
			 		<label for="cmbPais" style="width: 125px;">Pais:</label>
				</div>
				<div class="der">
