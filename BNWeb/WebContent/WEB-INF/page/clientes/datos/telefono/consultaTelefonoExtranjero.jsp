...
<script language="javascript">
	...
	function desactivarTipoTelefono(){
		...
		//frmDatosClientes.cmbTipoTelefono.disabled = true;
	}
...
<input type="hidden" name="validar" value="true"/>
	...
	<div id="contenidos-informativos" >
		<h2>ACTUALIZAR TELEFONO FIJO</h2>
		<h2></h2>
		...
		<div class="clear "></div>
			<div class="fila limpiar">
				...
				<html:text property="txtTelefono" styleClass="input-chico4" styleId="txtTelefono3" maxlength="20" onkeypress="return soloNumerosAll(event)" />
