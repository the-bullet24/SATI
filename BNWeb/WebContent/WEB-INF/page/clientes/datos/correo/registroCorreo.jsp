...
<script language="javascript">
	...
	function guardar(){
		...
		frmDatosClientes.validar.value  = false;
		frmDatosClientes.metodo.value  = 'guardarCorreo';
		frmDatosClientes.action = '<%=request.getContextPath()%>/AfilDatosClientes.do';
		frmDatosClientes.submit();	
	}
...
<input type="hidden" name="validar" />
	...
	<div id="contenidos-informativos" >
		<h2>NUEVO CORREO ELECTRONICO</h2>
		<h2></h2>
		...
		<div class="fila limpiar" style="padding: 10px;">
			<div class="clear "></div>
		 		...
		 		<label for="cmbTipoEmail">Tipo de Correo Eletrónico:</label>
						

		 		<html:select property="cmbTipoEmail" styleClass="select select-grande" >
