	...
	<div id="contenidos-informativos">
		...
		<div class="clear cincopx"></div>
			...
			<div class="der">
					 ...
					 <html:select property="cmbCuenta"  styleClass="select select-grande" onchange="jsSubmitPersonalizado('consultaMedioEnvio','/AfilDatosClientes.do')">
			...
			<div class="fila limpiar"></div>
					...
					<div class="der">
									<html:select property="cmbDireccionCorresp" styleId="cmbDireccionCorresp"  styleClass="select select-grande2" onchange="nuevaDireccion()">					  					
									    <option value="" >Seleccione...</option>
                                        ...
                                        <option value="00" >Nueva Dirección</option>
									</html:select>
		...
		<div>
				...
				IMPORTANTE: 
				Estimado cliente se le informa que en el registro y/o actualización de correos electrónicos personales se considerará para el envió de los Estados de Cuenta de sus Productos Pasivos, Crédito Hipotecario y/o Préstamo Multired; el último correo electrónico personal que USTED registre en este módulo; siempre y cuando haya seleccionado como medio de envío de sus Estados de Cuenta: Correo Electrónico.
