...
<script language="javascript">
	...
	function continuar(){
		...
		form.action="<%=request.getContextPath()%>/AfilDatosClientes.do?metodo=mostrarMedioEnvio";
		form.submit();
	...
	function generarClaveSms(e){		
	    ...
	    xmlhttp.open("POST", '<%=request.getContextPath()%>/AfilDatosClientes.do?metodo=reGenerarClaveSmsEnvio', true);
	    xmlhttp.send();
	    }
	}
...
<input type="hidden" name="metodo" >
	...
	<div id="contenidos-informativos">
		...
		<label for="cliente" class="cerrar" style="width: 100%; text-align: left;" >${mensajeCabeceraInicioEC} </label></div>
		...
		<div>
			<table>
				...
				<c:if test="${tipoElemento.tipoElementoSeguridad=='6'}">
					<tr>
						<td colspan="4" class="ingreso" style="width:592px;"><p><u><b>Nota:</b></u>
							<br>
