...
<SCRIPT language="javascript">
	...
	function desafiliar(){
		...
		frmDesafiliacion.action='<%=request.getContextPath()%>/desafTarjeta.do?metodo=finDesafiliar';
		frmDesafiliacion.submit();

	}

	function regresar(){
		frmDesafiliacion.action='<%=request.getContextPath()%>/desafTarjeta.do?metodo=regresar';
		frmDesafiliacion.submit();
		/*
		history.go(-1)
		*/
