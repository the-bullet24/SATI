...
<SCRIPT language="javascript">
	...
	function desafiliar(){
		...
		frmDesafiliacion.action='<%=request.getContextPath()%>/desafTarjetaBN.do?metodo=finDesafiliar';
		frmDesafiliacion.submit();

	}

	function regresar(){
		frmDesafiliacion.action='<%=request.getContextPath()%>/desafTarjetaBN.do?metodo=regresar';
		frmDesafiliacion.submit();
		/*
		history.go(-1)
		*/
