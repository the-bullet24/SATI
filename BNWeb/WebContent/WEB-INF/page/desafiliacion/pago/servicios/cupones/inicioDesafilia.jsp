...
<SCRIPT language="javascript">
	...
	function desafiliar(){
		...
		frmDesafiliacion.action="<%=request.getContextPath()%>/desafCupones.do?metodo=finDesafiliar";
		frmDesafiliacion.submit();
	}

	
	function regresar(){
		frmDesafiliacion.action='<%=request.getContextPath()%>/desafCupones.do?metodo=regresar';
		frmDesafiliacion.submit();
		/*
		history.go(-1)
		*/
...
<h2><bean:write name="TITULO"/></h2>
			...
			<TABLE cellspacing="0" cellpadding="0"  width="435">
				<TBODY>
					<TR>
								<TD colspan="3" align="center" ><h3>LISTA DE SERVICIOS FRECUENTES</h3></TD>
					</TR>
					<TR>
