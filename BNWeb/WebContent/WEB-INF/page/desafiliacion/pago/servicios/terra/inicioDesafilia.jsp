...
<SCRIPT language="javascript">
	...
	function desafiliar(){
		...
		frmDesafiliacion.action='<%=request.getContextPath()%>/desafTerra.do?metodo=finDesafiliar';
		frmDesafiliacion.submit();

	}

	function regresar(){
		frmDesafiliacion.action='<%=request.getContextPath()%>/desafTerra.do?metodo=regresar';
		frmDesafiliacion.submit();
		/*
		history.go(-1)
		*/
