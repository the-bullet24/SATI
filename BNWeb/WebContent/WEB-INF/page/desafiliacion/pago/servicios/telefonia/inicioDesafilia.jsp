...
<SCRIPT language="javascript">
	...
	function desafiliar(){
		...
		frmDesafiliacion.action='<%=request.getContextPath()%>/desafTelefonia.do?metodo=finDesafiliar';
	...
	function regresar(){
		frmDesafiliacion.action='<%=request.getContextPath()%>/desafTelefonia.do?metodo=regresar';
		frmDesafiliacion.submit();
		/*
		history.go(-1)
		*/
