...
<SCRIPT language="javascript">
	...
	function desafiliar(){
		...
		frmDesafiliacion.action='<%=request.getContextPath()%>/desafRecargaMov.do?metodo=finDesafiliar';
	...
	function regresar(){
		frmDesafiliacion.action='<%=request.getContextPath()%>/desafRecargaMovr.do?metodo=regresar';
		frmDesafiliacion.submit();
		/*
		history.go(-1)
		*/
