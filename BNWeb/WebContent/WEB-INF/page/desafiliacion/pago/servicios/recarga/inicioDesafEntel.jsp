...
<SCRIPT language="javascript">
	...
	function desafiliar(){
		...
		frmDesafiliacion.action='<%=request.getContextPath()%>/desafRecargaEntel.do?metodo=finDesafiliar';
		frmDesafiliacion.submit();

	}

	function regresar(){
		frmDesafiliacion.action='<%=request.getContextPath()%>/desafRecargaBitel.do?metodo=regresar';
		frmDesafiliacion.submit();
		/*
		history.go(-1)
		*/
