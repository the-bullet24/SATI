...
<SCRIPT language="javascript">
	...
	function desafiliar(){
		...
		frmDesafiliacion.action='<%=request.getContextPath()%>/desafSedapal.do?metodo=finDesafiliar';
	...
	function regresar(){
		frmDesafiliacion.action='<%=request.getContextPath()%>/desafSedapal.do?metodo=regresar';
		frmDesafiliacion.submit();
		/*
		history.go(-1)
		*/
