...
<SCRIPT language="javascript">
	...
	function desafiliar(){
		...
		frmDesafiliacion.action='<%=request.getContextPath()%>/desafCable.do?metodo=finDesafiliar';
	...
	function regresar(){
		frmDesafiliacion.action='<%=request.getContextPath()%>/desafCable.do?metodo=regresar';
		frmDesafiliacion.submit();
		/*
		history.go(-1)
		*/
