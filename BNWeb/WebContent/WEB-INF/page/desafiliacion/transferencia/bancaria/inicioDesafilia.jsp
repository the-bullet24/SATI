...
<SCRIPT language="javascript">
	...
	function desafiliar(){
		...
		frmDesafiliacion.action='<%=request.getContextPath()%>/desafTransfBancaria.do?metodo=finDesafiliar';
	...
	function regresar(){
		frmDesafiliacion.action='<%=request.getContextPath()%>/desafTransfBancaria.do?metodo=regresar';
		frmDesafiliacion.submit();
		/*
		history.go(-1)
		*/
				...
				<TBODY>
					...
					<table width="435">
						<TR>
							...
							<center><p class="mensaje">No existen registros frecuentes asociados</p></center>
							</TD>
						</TR>
