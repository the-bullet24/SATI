...
<script language="javascript">
	function pagar(){
		...
		form.action = '<%=request.getContextPath()%>/pagoTarjetaLinea.do?metodo=pagar';
		form.submit();
...
var enableLinkReenvio = true;
 function generarClaveSms(e){		
	    ...
	    xmlhttp.open("POST", '<%=request.getContextPath()%>/pagoTarjetaLinea.do?metodo=reGenerarClaveSms', true);
	    xmlhttp.send();
	    }
	}
		...
		<div style="width: auto;">
			...
			<TABLE >
				<TBODY>
					...
					<TR >
						<TD colspan="2" width="40%"  height="20" >Nro. Cuenta Origen:</TD>
						<TD  height="22" nowrap="nowrap"  width="60%"><bean:write name="<%=pe.cosapi.common.ConstanteSesion.PAGO_TARJETA%>" property="cuenta.nombreTipoProducto"/> - <bean:write name="<%=pe.cosapi.common.ConstanteSesion.PAGO_TARJETA%>" property="cuenta.simboloMonedaProducto"/> - <bean:write name="<%=pe.cosapi.common.ConstanteSesion.PAGO_TARJETA%>" property="cuenta.cuentaFormateada"/>
							
						</TD>
					</TR>
					<TR >
						<TD colspan="2" width="40%"  height="20" >Banco Destino:</TD>
					...
					<TR >
						<TD colspan="2" width="40%"  height="20" >Nro. Tarjeta Crédito:</TD>
						<TD width="60%"  height="23" ><bean:write name="<%=pe.cosapi.common.ConstanteSesion.PAGO_TARJETA%>" property="afiliacion.numeroServicio"/></TD>
					</TR>
					<TR >
						<TD colspan="2" width="40%"  height="20" >Beneficiario:</TD>
						<TD width="60%"  height="23" ><bean:write name="<%=pe.cosapi.common.ConstanteSesion.PAGO_TARJETA%>" property="afiliacion.beneficiario"/></TD>
					</TR>
					<TR >
						<TD colspan="2" width="40%"  height="20" >Moneda:</TD>
						<TD width="60%"  height="23" ><bean:write name="<%=pe.cosapi.common.ConstanteSesion.PAGO_TARJETA%>" property="nombreMoneda"/></TD>

					</TR>
					<TR >
						<TD colspan="2" width="40%"  height="20" >Importe:</TD>
						<TD width="60%"  height="24"  style="text-align: right"><bean:write name="<%=pe.cosapi.common.ConstanteSesion.PAGO_TARJETA%>" property="simboloMoneda"/> <bean:write name="<%=pe.cosapi.common.ConstanteSesion.PAGO_TARJETA%>" property="importe"/></TD>

					</TR>
					<logic:equal name="<%=pe.cosapi.common.ConstanteSesion.PAGO_TARJETA%>" property="esMismaMoneda" value="false">
					<TR >
						<TD colspan="2" width="40%"  height="20" >Importe Al Cambio:</TD>
						<TD width="60%"  height="24"  style="text-align: right"><bean:write name="<%=pe.cosapi.common.ConstanteSesion.PAGO_TARJETA%>" property="cuenta.simboloMonedaProducto"/> <bean:write name="<%=pe.cosapi.common.ConstanteSesion.PAGO_TARJETA%>" property="importeAlCambio"/></TD>

					</TR>
					</logic:equal>
					<TR >
						<TD colspan="2" width="40%"  height="20" >Total Comisión:</TD>
						<TD width="60%"  height="20"  style="text-align: right">
						<bean:write name="<%=pe.cosapi.common.ConstanteSesion.PAGO_TARJETA%>" property="cuenta.simboloMonedaProducto" />
  						<bean:write name="<%=pe.cosapi.common.ConstanteSesion.PAGO_TARJETA%>" property="comision"/></TD>
					</TR>
					<TR >
						<TD colspan="2" width="40%"  height="20" >Total ITF:</TD>
						<TD width="60%"  height="22"  style="text-align: right"><bean:write
					...
					<TR >
						<TD colspan="2" width="40%"  
							height="20">Total Operación:</TD>
						<TD width="60%"   style="text-align: right" height="20"><bean:write name="<%=pe.cosapi.common.ConstanteSesion.PAGO_TARJETA%>" property="cuenta.simboloMonedaProducto"/> <bean:write name="<%=pe.cosapi.common.ConstanteSesion.PAGO_TARJETA%>" property="total"/></TD>
					</TR>
					<TR>
							<TD colspan="2">&nbsp;</TD>
					</TR>
			...
			<TR >
					...
					<TR>
							<TD height="20" colspan="2"   ><label class="clavesms" style="width: 180px;">¿Desea adicionar como frecuente?</label>
				...
				<TR >
					...
					<c:if test="${afiliacion.flagRegistro=='N'}">
					<TR>
							<TD height="20" colspan="1"   ><label class="clavesms">¿Desea adicionar como frecuente?</label>
							<input type="checkbox" name="adicionar" value="A" onclick="mostrarCaja();"><BR>
							</TD>
						
							<TD  id="adi" ><label class="clavesms">Nombre del frecuente: </label><br/><input type="text" name="txtNombreAfil" class="input-grande"  maxlength="30" ></TD>
					</TR>
							<TR>
							<TD height="20" colspan="3" >
							</TD>
