...
function mostrarCaja(){
	...
	function pagar(){
		...
		form.action = '<%=request.getContextPath()%>/pagoTarjetaBN.do?metodo=pagarTCredito';
		form.submit();
...
$('.tooltip').click(function() {
	$('#dvHelpMessage').toggle();
 	...
 	function generarClaveSms(e){		
	    ...
	    xmlhttp.open("POST", '<%=request.getContextPath()%>/pagoTarjetaBN.do?metodo=reGenerarClaveSms', true);
	    xmlhttp.send();
	    }
...
<div id="contenidos-informativos">
		...
		<table>				
			...
			<tr>
				...
				<bean:write name="<%=pe.cosapi.common.ConstanteSesion.PAGO_TC%>" property="cuentaCredito.cuentaFormateada" ignore="true"/>
				</label>
				</td>
			</tr>	
			<tr>
        		<td class="iz"><label class="clavesms">Titular de la Tarjeta de Crédito </label></td>
				<td class="der">

				<label style="margin-left:20px; font-family:Arial; width: 165px;">
