...
function mostrarCaja(){
	...
	function pagar(){
		...
		form.action = '<%=request.getContextPath()%>/pagoTarjetaOtrosBN.do?metodo=pagarTCredito';
		form.submit();
	...
	function regresar(){
		var form = document.frmPagoTC;
		form.action = "<%=request.getContextPath()%>/pagoTarjetaOtrosBN.do";
		form.submit();
	}
...
$('.tooltip').click(function() {
	...
	function generarClaveSms(e){		
	    ...
	    xmlhttp.open("POST", '<%=request.getContextPath()%>/pagoTarjetaOtrosBN.do?metodo=reGenerarClaveSms', true);
	    xmlhttp.send();
	    }
...
<div id="contenidos-informativos">
		...
		<table>				
			...
			<tr>
        		<td class="iz"><label class="clavesms">Nro. Tarjeta de Crédito </label></td>
				<td class="der">
				<label style="margin-left:20px; font-family:Arial ; ">
				<bean:write name="<%=pe.cosapi.common.ConstanteSesion.PAGO_TC%>" property="cuentaCredito.numeroProducto" ignore="true"/>
				</label>
				</td>
			</tr>	
			<tr>
        		<td class="iz"><label class="clavesms" style="width: 180px;">Titular de la Tarjeta de Crédito: </label></td>
				<td class="der">
				<label style="margin-left:20px; font-family:Arial ; ">
				<bean:write name="<%=pe.cosapi.common.ConstanteSesion.PAGO_TC%>" property="cuentaCredito.nombreCliente" ignore="true"/>
				</label>
				</td>
			</tr>				
			<tr>
				<td class="iz"><label class="clavesms">Importe a Pagar:</label></td>
				<td class="der">
				<label style="margin-left:20px; font-family:Arial; width:337px;text-align: right;">
				<bean:write name="<%=pe.cosapi.common.ConstanteSesion.PAGO_TC%>" property="montoPagado" ignore="true"/>
				</label>
				</td>
			</tr>			
			<tr>
		...
		<c:if test="${tipoElemento.tipoElementoSeguridad=='5'}">
			...
			<tr>
				...
				<c:if test="${afiliacion.flagRegistro=='N'}">
					<TR>
							<TD height="20"  ><label class="clavesms"style="width: 195px;">¿Desea adicionar como frecuente?</label>
