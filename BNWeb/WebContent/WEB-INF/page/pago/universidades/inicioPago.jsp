...
<script language="javascript">
	...
	function continuar(){
		...
		if (validaRadios("opcionPago")){
		   ...
		   if(document.forms[0].opcionPago[0].checked==true){
					
				if (validacampo("txtCodigo")){
				alert('Es necesario ingresar el codigo del alumno');
				document.frmPagoUniversidades.boton.disabled=false
				return;
				}
			...
			if(document.forms[0].opcionPago[1].checked==true){
			...
			<logic:equal name="hidServicio" value="9">
				document.forms[0].action ="<%=request.getContextPath()%>/pagoUniversidades.do?metodo=verConsultaAlumno";
			</logic:equal>
   ...
   <div class="clear cincopx"></div>
	...
	<div class="izq">
	 ...
	 <div class="clear cincopx"></div>
	  ...
	  <div class="izq">
  	  <label for="numero-documento">Opción de Pago:</label>
  	</div>
  	<div class="der">
  	    <div class="opciones-radio">
        <span class="textizqn"><input type="radio" name="opcionPago" value="A" onclick="radioAlumno()"  /> <strong>Alumno</strong></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<span class="textizqn"><strong><input type="radio" name="opcionPago" value="O" onclick="radioOtros()" /> Particular/Otros</strong></span>
		</div>
  	</div>
  	 <div class="clear cincopx"></div>
	 	
      <div class="formEstandar oculto" id="formAlumno">
      
    	<div class="izq">
    		<label for="cmbTelegiro"> Codigo Alumno:</label>
    	</div>
    	<div class="der">
    	<input type="text" class="input-chico" name="txtCodigo" maxlength="12" />
    	</div>
    	   <div class="clear "></div>
    </div>
    
     <div class="formEstandar oculto" id="formOtros">
