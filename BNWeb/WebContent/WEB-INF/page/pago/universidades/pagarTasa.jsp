...
<SCRIPT language="javascript">
	function imprimir(){
		window.open('<%=request.getContextPath()%>/util.do?metodo=solicitarRefrendo&variableSesion=<%=pe.cosapi.common.ConstanteSesion.PAGO_UNIVERSIDADES%>&idObjeto=refrendoPagoTasasEducativas',"BN","toolbar=0,location=0,width=480,height=430, scrollbars=no, resizable=yes,  top=" + ((screen.height/2)-(420/2))+", left="+((screen.width/2)-(400/2)));
	}

	function enviar(){
		window.open('<%=request.getContextPath()%>/util.do?metodo=verMail&variableSesion=<%=pe.cosapi.common.ConstanteSesion.PAGO_UNIVERSIDADES%>&idObjeto=mailPagoTasasEducativas',"Mail","toolbar=0,location=0,width=540,height=500, scrollbars=no, resizable=yes,  top=" + ((screen.height/2)-(620/2))+", left="+((screen.width/2)-(510/2)));
	}
function Verificar()
 {
...
var pressedKey = String.fromCharCode(event.keyCode).toLowerCase();  
  ...
  function verPdf(){
		...
		form.idObjeto.value = 'refrendoPagoTasasEducativas';
...
<div id="contenidos-informativos">
	...
	<table class="constancia">
		...
		<TR >
			...
			<TD ><bean:write name="<%=pe.cosapi.common.ConstanteSesion.PAGO_UNIVERSIDADES%>" property="fechaSistema" ignore="true" /></TD>
		</TR>
		<TR >
		...
		<TR >
						...
						<bean:write name="<%=pe.cosapi.common.ConstanteSesion.PAGO_UNIVERSIDADES%>" property="numeroSecuencia" ignore="true"/> 
						<bean:write name="<%=pe.cosapi.common.ConstanteSesion.PAGO_UNIVERSIDADES%>" property="fecha" ignore="true"/> 
						<bean:write name="<%=pe.cosapi.common.ConstanteSesion.PAGO_UNIVERSIDADES%>" property="codTransaccion" ignore="true"/> 
						<bean:write name="<%=pe.cosapi.common.ConstanteSesion.PAGO_UNIVERSIDADES%>" property="codUsuario" ignore="true"/> 
						<bean:write name="<%=pe.cosapi.common.ConstanteSesion.PAGO_UNIVERSIDADES%>" property="codAgencia" ignore="true"/> 
						<bean:write name="<%=pe.cosapi.common.ConstanteSesion.PAGO_UNIVERSIDADES%>" property="hora" ignore="true"/>
						<bean:write name="<%=pe.cosapi.common.ConstanteSesion.PAGO_UNIVERSIDADES%>" property="digitoControl" ignore="true"/>
						</TD>
