...
<script language="javascript" type="text/javascript">
	function consultar(parametro){
		if (parametro.value!=''){ //Diferente de "Seleccione..." 
			...
			var tipoUni = parametro.substring(12,17);
			var nomEntidad = parametro.substring(18,lenPar);
			...
			if (tipoTrx=='<%=pe.cosapi.common.Constante.PAGO_SERVICIOS_TIPO_TRX_TELEFONICA_FIJA%>'){
				...
				form.HrTrx.value="PS10";
	    		form.action = "<%=request.getContextPath()%>/recargaTelefono.do";
			}else if (tipoTrx=='<%=pe.cosapi.common.Constante.PAGO_SERVICIOS_TIPO_TRX_ENTEL_RECARGAS%>'){
				form.hidServicio.value 	= '16';
				form.HrTrx.value="PS10";
	    		form.action = "<%=request.getContextPath()%>/recargaTelefono.do";
				...
				form.hidServicio.value 	= '9';
				var tipoPago = codServ.substring(0,2);
				
				if (tipoUni == '00500'){
					form.HrTrx.value="PC00";
		    		form.action = "<%=request.getContextPath()%>/pagoCupones.do";
				} else {
						if (tipoPago == '<%=pe.cosapi.common.Constante.PAGO_SERVICIOS_GRP_UNIVERSIDADES%>'){
							form.HrTrx.value="PU00";
		    				form.action = "<%=request.getContextPath()%>/pagoUniversidades.do";
						}else{
							form.HrTrx.value="TE00";
		    				form.action = "<%=request.getContextPath()%>/pagoTasasEducativas.do";
						}
	...
	function load(){
		...
		$("select").selectmenu("destroy").selectmenu({ maxHeight:"300", style: "dropdown" });
	
	}
</script>
<title>Pago de Telefonía Fija</title>
</head>
<body oncontextmenu="return false" onselectstart="return false" ondragstart="return false"  onkeydown="return cancelRefresh(event)" bgcolor="white" onload="load()">
		...
		<div class="combo-izquierda">
			...
			<select name="cboTelefono" class="select select-grande" onchange="javascript:consultar(this.value);">	
				...
				<logic:iterate name="<%=pe.cosapi.common.ConstanteSesion.PAGO_SERVICIOS_GRP_TELEFONO%>" id="telefono" >
					<option value='<bean:write name="telefono" property="codigoDetalleAyuda"/>-<bean:write name="telefono" property="codigoDetalleAyuda1"/>-<bean:write name="telefono" property="codigoAyuda"/>-<bean:write name="telefono" property="descripcionDetalle"/>'><bean:write name="telefono" property="descripcionDetalle" /></option>
				</logic:iterate>
			</select>	
		</div>
		...
		<div class="combo-derecha">
			...
			<select name="cboAgua" class="select select-grande" onchange="javascript:consultar(this.value);">			
				...
				<logic:iterate name="<%=pe.cosapi.common.ConstanteSesion.PAGO_SERVICIOS_GRP_AGUA%>" id="agua" >
					<option value='<bean:write name="agua" property="codigoDetalleAyuda"/>-<bean:write name="agua" property="codigoDetalleAyuda1"/>-<bean:write name="agua" property="codigoAyuda"/>-<bean:write name="agua" property="descripcionDetalle"/>'><bean:write name="agua" property="descripcionDetalle" /></option>
				</logic:iterate>
			</select>
		</div>
		<div class="combo-izquierda">
			...
			<select name="cboCelular" class="select select-grande" onchange="javascript:consultar(this.value);">			
				...
				<logic:iterate name="<%=pe.cosapi.common.ConstanteSesion.PAGO_SERVICIOS_GRP_CELULAR%>" id="celular" >
					<option value='<bean:write name="celular" property="codigoDetalleAyuda"/>-<bean:write name="celular" property="codigoDetalleAyuda1"/>-<bean:write name="celular" property="codigoAyuda"/>-<bean:write name="celular" property="descripcionDetalle"/>'><bean:write name="celular" property="descripcionDetalle" /></option>
				</logic:iterate>
			</select>
		</div>
		<div class="combo-derecha">
			...
			<select name="cboLuz" class="select select-grande" onchange="javascript:consultar(this.value);">			
				...
				<logic:iterate name="<%=pe.cosapi.common.ConstanteSesion.PAGO_SERVICIOS_GRP_LUZ%>" id="luz" >
					<option value='<bean:write name="luz" property="codigoDetalleAyuda"/>-<bean:write name="luz" property="codigoDetalleAyuda1"/>-<bean:write name="luz" property="codigoAyuda"/>-<bean:write name="luz" property="descripcionDetalle"/>'><bean:write name="luz" property="descripcionDetalle" /></option>
				</logic:iterate>
			</select>
		</div>
		<div class="combo-izquierda">
			...
			<select name="cboCable" class="select select-grande" onchange="javascript:consultar(this.value);">			
				...
				<logic:iterate name="<%=pe.cosapi.common.ConstanteSesion.PAGO_SERVICIOS_GRP_CABLE%>" id="cable" >
					<option value='<bean:write name="cable" property="codigoDetalleAyuda"/>-<bean:write name="cable" property="codigoDetalleAyuda1"/>-<bean:write name="cable" property="codigoAyuda"/>-<bean:write name="cable" property="descripcionDetalle"/>'><bean:write name="cable" property="descripcionDetalle" /></option>
				</logic:iterate>
			</select>
		</div>
		<div class="combo-derecha">
			<label for="cboUniversidades" class="pagos">Universidades</label>
			<select name="cboUniversidades" class="select select-grande" onchange="javascript:consultar(this.value);">			
				...
				<logic:iterate name="<%=pe.cosapi.common.ConstanteSesion.PAGO_SERVICIOS_GRP_UNIVERSIDADES%>" id="universidades" >
					<option value='<bean:write name="universidades" property="codigoDetalleAyuda"/>-<bean:write name="universidades" property="codigoDetalleAyuda1"/>-<bean:write name="universidades" property="codigoAyuda"/>-<bean:write name="universidades" property="descripcionDetalle"/>'><bean:write name="universidades" property="descripcionDetalle" /></option>
				</logic:iterate>
			</select>
		</div>
		<div class="combo-izquierda">
			...
			<select name="cboColegios" class="select select-grande" onchange="javascript:consultar(this.value);">			
				...
				<logic:iterate name="<%=pe.cosapi.common.ConstanteSesion.PAGO_SERVICIOS_GRP_INTERNET%>" id="internet" >
					<option value='<bean:write name="internet" property="codigoDetalleAyuda"/>-<bean:write name="internet" property="codigoDetalleAyuda1"/>-<bean:write name="internet" property="codigoAyuda"/>-<bean:write name="internet" property="descripcionDetalle"/>'><bean:write name="internet" property="descripcionDetalle" /></option>
				</logic:iterate>
			</select>
		</div>
		<div class="combo-derecha">
			...
			<select name="cboEmpresas" class="select select-grande" onchange="javascript:consultar(this.value);">			
				...
				<logic:iterate name="<%=pe.cosapi.common.ConstanteSesion.PAGO_SERVICIOS_GRP_EMPRESAS%>" id="empresas" >
					<option value='<bean:write name="empresas" property="codigoDetalleAyuda"/>-<bean:write name="empresas" property="codigoDetalleAyuda1"/>-<bean:write name="empresas" property="codigoAyuda"/>-<bean:write name="empresas" property="descripcionDetalle"/>'><bean:write name="empresas" property="descripcionDetalle" /></option>
				</logic:iterate>
			</select>
		</div>
		<div class="combo-izquierda">
			...
			<select name="cboEmpPublico" class="select select-grande" onchange="javascript:consultar(this.value);">			
				...
				<logic:iterate name="<%=pe.cosapi.common.ConstanteSesion.PAGO_SERVICIOS_GRP_EMP_PUB%>" id="emp_publica" >
					<option value='<bean:write name="emp_publica" property="codigoDetalleAyuda"/>-<bean:write name="emp_publica" property="codigoDetalleAyuda1"/>-<bean:write name="emp_publica" property="codigoAyuda"/>-<bean:write name="emp_publica" property="descripcionDetalle"/>'><bean:write name="emp_publica" property="descripcionDetalle" /></option>
				</logic:iterate>
			</select>
		</div>
		<div class="combo-derecha">
