...
<SCRIPT language="javascript">
	...
	function aceptar(){
		...
		form.action="<%=request.getContextPath()%>/recargaTelefono.do?metodo=pagarRecargaMovistar";
...
<input type="hidden" name="txtServicioRecargoMovistar" value="<bean:write name="afiliacion" property="numeroServicio" ignore="true"/>"/>
	...
	<h2><bean:write name="TITULO" /></h2>
		...
		<table style="width:100%;">				
			...
			<tr>
				...
				<td colspan="2"class="der">
        			<label style="margin-left:20px; font-family:Arial;"><bean:write name="afiliacion" property="numeroServicio" /></label></td>
			</tr>
			<tr>
				<td colspan="2" class="iz"><label class="clavesms">Importe:</label> </td>
				<td colspan="2"class="der">
        			<label style="margin-left:20px; font-family:Arial;"><bean:write	name="cuenta" property="simboloMonedaProducto" ignore="true" />
			...
			<logic:equal name="cuenta" property="simboloMonedaProducto" value="US$">
				<tr>
					...
					<td colspan="2"class="der">
        			<label style="margin-left:20px; font-family:Arial;">S/ <bean:write name="tipoCambioCompra" /></label></td>
				</tr>
				<tr>
					<td colspan="2" class="iz"><label class="clavesms">Importe:</label></td>
					<td colspan="2"class="der">
        			<label style="margin-left:20px; font-family:Arial;">S/ <bean:write name="<%=pe.cosapi.common.ConstanteSesion.CONSULTA%>" property="importe" />
        			</label>
        			</td>
				</tr>
			</logic:equal>
			...
			<tr>
        		...
        		<td colspan="2"class="der">
        			...
        			<bean:write name="cuenta" property="nombreTipoProducto" ignore="true" /> - 
					<bean:write	name="cuenta" property="simboloMonedaProducto" ignore="true" /> -
					<bean:write name="cuenta" property="cuentaFormateada" /></label>        		</td>
       		</tr>
			<tr>
				<td colspan="2"class="iz"><label class="clavesms">Nro. Telefónico / Abonado: </label></td>
				<td colspan="2"class="der">
        			<label style="margin-left:20px; font-family:Arial;"><bean:write name="afiliacion" property="numeroServicio" />
        			</label>
        			</td>
			</tr>
			<tr>
			...
			<logic:equal name="cuenta" property="simboloMonedaProducto" value="US$">
				<tr>
					<td colspan="2"class="iz"><label class="clavesms">Tipo de Cambio :</label> </td>
					<td colspan="2">S/ <bean:write name="tipoCambioCompra" /></td>
				</tr>
				<tr>
					<td colspan="2"class="iz"><label class="clavesms">Importe:</label></td>
					<td colspan="2"class="der">
			...
			<tr>
				...
				<td colspan="2"><bean:write name="afiliacion" property="numeroServicio" /></td>
			</tr>
			<tr>
				<td colspan="1"class="iz"><label class="clavesms">Importe: </label></td>
				<td colspan="2"class="der">
        			<label style="margin-left:20px; font-family:Arial; width:337px;text-align: right;"><bean:write	name="cuenta" property="simboloMonedaProducto" ignore="true" />
							<bean:write name="importe" />
							</label>
				</td>
			</tr>
			...
			<tr>
				<td colspan="2" ><label class="clavesms" style="width: 195px;">¿Desea adicionar como frecuente?</label>
			...
			<c:if test="${tipoElemento.tipoElementoSeguridad=='2'}">
			<tr>
				<td colspan="4"  class="ingreso"  style="width:592px;" ><p><u>Ejemplo:</u>
