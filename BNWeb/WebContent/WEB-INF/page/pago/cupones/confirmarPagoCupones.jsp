...
<SCRIPT language="javascript">
    ...
    function pagar(){
        ...
        if('<c:out value="${afiliacion.flagRegistro}"/>' == 'N'){		
			...
			alert('Ingresar solo letras a excepcion de la ñ. No considerar tildes ni números'); 
            document.frmPago.boton.disabled = false;
            return;
            }
           }
        ...
        if(tipoElemento == '5')
        {
            ...
            if (validacampo("txtCoordenada")){
                alert('Es necesario ingresar los 8 digitos del token sms');
                document.frmPago.boton.disabled = false;
                return;
            }
            if (validalongitud("txtCoordenada","8")){
                alert('El pin del Token es de 8 digitos, no menos');
                document.frmPago.boton.disabled = false;
                return;
            }
        ...
        form.action = '<%=request.getContextPath()%>/pagoCupones.do?metodo=pagarCupones';
        form.submit();
    ...
    function regresar(){
        var form = document.frmPago;
        form.transaccion.value="PC00";
        form.cmbCuenta.value = "<bean:write name="<%=pe.cosapi.common.ConstanteSesion.CONSULTA%>" property="cuenta.numeroProducto"/>";
        form.cmbPagoCupones.value = "<bean:write name="afiliacion" property="tipoAfiliacion"/>-<bean:write name="afiliacion" property="nroTarjeta"/>-<bean:write name="afiliacion" property="secuencia"/>";
    ...
    function generarClaveSms(){		
		...
		xmlhttp.open("POST", '<%=request.getContextPath()%>/pagoCupones.do?metodo=reGenerarClaveSms', true);
	    xmlhttp.send();
	    }
...
<input type="hidden" name="txtServicioCupones" value="<bean:write name="afiliacion" property="numeroServicio" ignore="true"/>"/>
...
<div id="contenidos-informativos">
    ...
    <div style="width:auto;">
        <table cellspacing="10" width="100%">
            ...
            <tr>     
                <td class="iz">
                    <label class="clavesms">Banco / Empresa:</label>  
                </td>
                <td class="der" colspan="3">
            ...
            <tr>
                ...
                <td class="der" colspan="3">
                    <label style="margin-left:20px; font-family:Arial; font-size:12px;">
                        <bean:write name="<%=pe.cosapi.common.ConstanteSesion.CONSULTA%>" property="cliente"/>
                    </label>
                </td>
            </tr>
            <tr>
                <td class="iz">
                    <label class="clavesms">Nro. Cuota:</label>	
                </td>
                <td class="der" colspan="3">
                    <label style="margin-left:20px; font-family:Arial; font-size:12px;">
            ...
            <tr>
                <td class="iz">
                    <label class="clavesms">Fecha de Vencimiento:</label>	
                </td>
                <td class="der" colspan="3">
                    <label style="margin-left:20px; font-family:Arial; font-size:12px;">
            ...
            <tr>
                ...
                <td class="der" colspan="3">
                    <label style="margin-left:20px; font-family:Arial; width:337px;text-align: right;">
                        <bean:write name="<%=pe.cosapi.common.ConstanteSesion.CONSULTA%>" property="moneda" ignore="true"/> 
                        <bean:write name="<%=pe.cosapi.common.ConstanteSesion.CONSULTA%>" property="recibo.importe" ignore="true"/>
                    </label>
                </td>
            </tr>
            <!-- Inicio 2019-M0400 -->
            <tr>
                <td class="iz">
                    <label class="clavesms">Mora:</label>	
                </td>
                <td class="der" colspan="3">
                   <label style="margin-left:20px; font-family:Arial; width:337px;text-align: right;">
                        <bean:write name="<%=pe.cosapi.common.ConstanteSesion.CONSULTA%>" property="moneda" ignore="true"/> 
                        <bean:write name="<%=pe.cosapi.common.ConstanteSesion.CONSULTA%>" property="recibo.mora" ignore="true"/>
                    </label>
                </td>
            </tr>
            <tr>
                <td class="iz">
                    <label class="clavesms">Total:</label>	
                </td>
                <td class="der" colspan="3">
                    <label style="margin-left:20px; font-family:Arial; width:337px;text-align: right;">
                        <bean:write name="<%=pe.cosapi.common.ConstanteSesion.CONSULTA%>" property="moneda" ignore="true"/> 
                        <bean:write name="<%=pe.cosapi.common.ConstanteSesion.CONSULTA%>" property="recibo.importeTotal" ignore="true"/>
                    </label>
                </td>
            </tr>
            <!-- Fin 2019-M0400 -->
        ...
        <c:if test="${tipoElemento.tipoElementoSeguridad=='5'}">
            <tr>
                <td class="iz">
                    <label class="clavesms" style="font-family: Arial Narrow;text-align:right;font-size:13px;line-height: 20px;position:relative;top:-30px;width:160px;">
                        Utilice el teclado virtual para ingresar el Token:
                    </label>
                </td>
