...
<SCRIPT language="javascript">
	...
	function afiliar(){
		...
		frmAfilPagoServicio.action="<%=request.getContextPath()%>/afilSedapal.do?metodo=afiliar";
...
<input type="hidden" name="codAf" value="00441">
			...
			<TABLE border="0" cellspacing="1" cellpadding="0" width="419">
				<TBODY>
					...
					<c:if test="${tipoElemento.tipoElementoSeguridad=='5'}">
						...
						<TD  height="20"  bgcolor="#e5e5de" height="20" colspan="2" bgcolor="#e5e5de" width="60%"><span class="textizqn"><B>
						...
						<INPUT type="password" name="txtCoordenada" size="10" maxlength="6"  onkeypress="return soloNumerosAll(event)"><BR>
							...
							<TD height="20"  bgcolor="#e5e5de" height="20" colspan="2" bgcolor="#e5e5de" width="40%"><img
					...
					<TR>
						<TD height="20" colspan="8" bgcolor="#e5e5de"><BR></TD>
					</TR>
					<c:if test="${tipoElemento.tipoElementoSeguridad=='2'}">
					<TR>
