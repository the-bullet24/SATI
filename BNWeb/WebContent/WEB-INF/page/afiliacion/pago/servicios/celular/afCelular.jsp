...
<SCRIPT language="javascript">
	...
	function afiliar(){
		...
		frmAfilPagoServicio.action="<%=request.getContextPath()%>/afilCelular.do?metodo=afiliar";
	...
	*/
	function evalRanTable(valor){
		document.forms[0].txtClave.value  = evaluarTeclado6(document.forms[0].txtClave.value,valor);
	}
