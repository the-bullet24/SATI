...
<SCRIPT language="javascript">
	...
	function afiliar(){
		...
		form.cmbServicio.value = "001";
		
		// Validando que el Nï¿½mero de DNI no tenga caracteres que no sean números
		...
		if (validacampo("cmbServicio")){ 
			alert('Es necesario seleccionar una entidad' ); return;}
		
		// Valida  que se ingrese el numero de servicio
		if (validacampo("txtNumServicio")){ 
			alert('Es necesario que ingrese el número de referencia' ); return;}
		...
		if (solocaracterespermitidos("txtNombreServicio")){
			alert('Ingresar sólo letras a excepción de la ï¿½. No considerar tildes' ); 
			return;
		}
		...
		frmAfilPagoServicio.action="<%=request.getContextPath()%>/afilCupones.do?metodo=afiliar";
...
<input type="hidden" name="cmbServicio">
		...
		<TR align="left" valign="top">
			...
			<TABLE border="0" cellspacing="1" cellpadding="0" width="419">
				<TBODY>
					...
					<TR bgcolor="#e5e5de">
						<TD colspan="2" height="20" width="189"><SPAN class="textizqn"><B>Nro. Referencia:</B></SPAN></TD>
						<TD colspan="2" height="20" width="227"><html:text property="txtNumServicio" size="20" maxlength="20" onkeypress="return soloNumerosAll(event)"/></TD>
					</TR>
					...
					<TR bgcolor="#e5e5de">
						...
						<TD height="20" colspan="2" bgcolor="#e5e5de" width="60%"></TD>
					...
					<TR bgcolor="#E5E5DE">
						...
						Ingresar los 6 d&iacute;gitos del TOKEN </B></span><LABEL><B>&nbsp; </B><FONT size="+1"><SPAN
					...
					<TR>
							<TD height="20" colspan="4" bgcolor="#e5e5de"><BR>
							</TD>
					</TR>
					<c:if test="${tipoElemento.tipoElementoSeguridad=='2'}">
					<TR>
						<TD colspan="4" height="20" width="40%" class="textizqn"  bgcolor="#e5e5de"><b><u>Ejemplo:</u>
							</b><br>
								Al solicitarle la coordenada <B>6 - F</B>, deber&iacute;as buscar la fila correspondiente al <b>n&uacute;mero
							6</b> y la columna de la <B>letra  F</B>, en la uni&oacute;n de ambos, obtendr&aacute;s un n&uacute;mero, &eacute;ste n&uacute;mero deber&aacute;s ingresarlo para aprobar la operaci&oacute;n.</TD>
						
					</TR>
					</c:if>
					<c:if test="${tipoElemento.tipoElementoSeguridad=='5'}">
					<TR>
						<TD colspan="4" height="20" width="40%" class="textizqn"  bgcolor="#e5e5de"><b><u>Nota:</u>
							</b><br>
