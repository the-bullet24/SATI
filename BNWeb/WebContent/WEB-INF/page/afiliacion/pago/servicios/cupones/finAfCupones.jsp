...
function verPdf(){
	var form = document.frmAfiliacionServicio;
				...
				form.variableSesion.value = '<%=pe.cosapi.common.ConstanteSesion.PAGO_CUPONES%>';
				form.titulo.value = 'PAGO DE CUPONES';
...
<TABLE width="100%" border="0" cellspacing="0">
   <TBODY>
		...
		<TR align="left" valign="top">
			...
			La afiliaci�n se realiz� con �xito<BR>
			<BR>
			</TD>
	    </TR>
		...
		<TR align="left" valign="top">
			<TD width="100%" align="center">
				...
				<tr height="20">
					<TD class="textizqn" width="50%" bgcolor="#e5e5de"><B>Detalle de la Afiliaci�n:</B></TD>
