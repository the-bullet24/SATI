...
<SCRIPT language="javascript">
	...
	function afiliar(){
		...
		frmAfilPagoServicio.action="<%=request.getContextPath()%>/afilCable.do?metodo=afiliar";
			...
			<TABLE border="0" cellspacing="1" cellpadding="0" width="419">
				<TBODY>
					...
					<TR bgcolor="#e5e5de">
						...
						<TD colspan="2" height="20" nowrap><html:text  property="txtNumDoc" size="7" maxlength="10" onkeypress="return selectVal(event)" onkeyup="return selectVal(event)"/></TD>
					</TR>
					<TR bgcolor="#e5e5de">
					...
					<TR bgcolor="#e5e5de" id="msjegeneral" style="display: none">
						...
						<TR bgcolor="#e5e5de">
						<TD colspan="2" height="20" width="227"><SPAN class="textizqn"><B>Nombre para recordar <BR>
					...
					<c:if test="${tipoElemento.tipoElementoSeguridad=='5'}">
						...
						<INPUT type="password" name="txtCoordenada" size="10" maxlength="6"  onkeypress="return soloNumerosAll(event)"><BR>
							<TD colspan="4" height="20"  bgcolor="#e5e5de" width="355"><img
