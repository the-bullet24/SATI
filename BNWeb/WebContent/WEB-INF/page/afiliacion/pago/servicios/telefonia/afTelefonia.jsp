...
<SCRIPT language="javascript">
	...
	function afiliar(){
		...
		frmAfilPagoServicio.action="<%=request.getContextPath()%>/afilTelefonia.do?metodo=afiliar";
				...
				<TBODY>
					...
					<TR bgcolor="#e5e5de">
						...
						<TD colspan="2" height="20" nowrap>
							<html:text  property="txtNumDoc" size="7" maxlength="10" onkeypress="return soloNumerosAll(event)" onkeypress="return selectVal(event)" onkeyup=" return selectVal(event)"/>
						</TD>
					</TR>
					<TR bgcolor="#e5e5de">
					...
					<c:if test="${tipoElemento.tipoElementoSeguridad=='2'}">
						<TR bgcolor="#e5e5de">
							...
							<TD  height="20" colspan="2" bgcolor="#e5e5de" width="355"><span class="textizqn"><B>
								Ingresar la Siguiente Coordenada<br></B></span><LABEL><B>&nbsp; </B><FONT size="+1">
								<SPAN style="color: #a80000"><B><c:if test="${resultCoord.coordConcat eq null}"> <br>No disponible</c:if>
					...
					<c:if test="${tipoElemento.tipoElementoSeguridad=='2'}">
						<TR>
							<TD colspan="5" height="20" width="40%" class="textizqn"  bgcolor="#e5e5de"><b><u>Ejemplo:</u>
								</b><br>
					...
					<c:if test="${tipoElemento.tipoElementoSeguridad=='5'}">
						<TR>
							<TD colspan="5" height="20" width="40%" class="textizqn"  bgcolor="#e5e5de"><b><u>Nota:</u>
								</b><br>
