...
<SCRIPT language="javascript">
	...
	function afiliar(){
		...
		frmAfilPagoServicio.action="<%=request.getContextPath()%>/afilFacturas.do?metodo=afiliar";
			...
			<TABLE border="0" cellspacing="1" cellpadding="0" width="419">
				<TBODY>
					...
					<TR bgcolor="#e5e5de">
						...
						<TD colspan="2" height="20" width="227"><html:text property="txtNumServicio" size="11" maxlength="10" onkeypress="return soloNumerosAll(event)"/></TD>
					</TR>
