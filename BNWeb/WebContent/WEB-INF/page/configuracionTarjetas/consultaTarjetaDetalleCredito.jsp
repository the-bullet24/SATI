...
function validarInformacion(){
	...
	var diaIda = fechaIda.substring(0,2);
	var mesIda = fechaIda.substring(3,5);
	var anoIda = fechaIda.substring(6,10);
	fechaIda =  mesIda+ "/" +diaIda+ "/" +anoIda;

	var fechaLlegada = $('#fechaVuelta').val();
	var diaLlegada = fechaLlegada.substring(0,2);
	var mesLlegada = fechaLlegada.substring(3,5);
	var anoLlegada = fechaLlegada.substring(6,10);
...
function precargarComboPaises(){
	...
	$("#cmbPaises").val(paises).trigger('chosen:updated')
}
						      ...
						      <table >
						            ...
						            <tr>
						               ...
						               <td colspan="1" style="padding-bottom: 10px;">
						                  <input type="text" name="fechaIda" id="fechaIda" maxlength="10" value=<c:out value="${cardDetalleResponse.shoppingAbroadSettings.dateDeparture}" />  />
						               ...
						               <td colspan="1" >
						                  <input type="text" name="fechaVuelta" id="fechaVuelta" maxlength="10" value=<c:out value="${cardDetalleResponse.shoppingAbroadSettings.dateReturn}" /> />
						         	...
						         	<tr>
						               ...
						               <td colspan="2" style="width:50%; padding-left: 0px;">
						               	...
						               	<input type="text" name="montoNotificacion" id="montoNotificacion" 
						               		...
						               		value=<c:out value="${cardDetalleResponse.notificationSettings.amountToReceiveNo}"/>
						               		/>
						               </td>
	   			                    </tr>
	   			                    <tr>
