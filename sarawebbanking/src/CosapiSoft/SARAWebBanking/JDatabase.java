 ...
 */
public JDatabase(String driver,String database,String user, String password) {
	this.error = "";
 ...
 */
public JDatabase(Connection connection) {
...
public Connection getConnection() throws SQLException {
	...
	//TODO
	//YADDIF A01
	//javax.sql.DataSource ds =(javax.sql.DataSource)ctx.lookup("java:comp/env/jdbc/dbSWB");
	javax.sql.DataSource ds =(javax.sql.DataSource)ctx.lookup("jdbc/dbSWB");
