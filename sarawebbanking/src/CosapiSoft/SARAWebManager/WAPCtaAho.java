...
public class WAPCtaAho extends GenericTable{
	//
...
public void loadGrid(JQuery db) throws Exception {
	try {
		...
		String query = //
		"Select numprdsrc,to_char(datpro,'DD/MM/YYYY HH24:MI:SS'),flgcom,nrocta,msghst " + //
		"From "+Constante.ESQUEMA2+".HJOUTRA " + //
		"Where codtrahst in ('1100') and flgcom in ('2','3') "+ //
		getQueryFecha() + //
		getQueryNroCta() + //
		getQueryEstado() + //
