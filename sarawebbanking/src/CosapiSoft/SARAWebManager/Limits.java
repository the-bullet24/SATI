...
public class Limits extends GenericTable {
	...
	public void consult() throws java.sql.SQLException {
		try {
			String bef[] = { "", "", "", "", "", "", "" };
			String aft[] = { "", "", "", "", "", "", "" };
			LogOpe.saveLogManager(getLogin().getNameProducto(), getLogin().getUsuario(), "Consultar", Constante.ESQUEMA1+".TLIMDAT", Table.getColumnsTlimdat(), bef, aft);
		} catch (Exception e) {
