...
var MonthNames = new Array("January", "Febrary", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December");
var nCurrentYear = 0;
var nCurrentMonth = 0;
...
HTMLstr += "<table width='210px' cellspacing='0' cellpadding='0' border='1'>\n";
...
if (ie) HTMLstr += "<td align='right' width='80'>\n";
...
if (ie)HTMLstr += "<div id='main' style='position: relative'>\n";
...
HTMLstr += "\n";
HTMLstr += "<td align='left'>\n";
if (ie)HTMLstr += "<div id='main2' style='position=relative;'>";
...
HTMLstr += "<td width='30'><b>Wen</b></td>\n";
HTMLstr += "<td width='30'><b>Thr</b></td>\n";
...
if (ie)HTMLstr += "<div style='position: relative;'>";
  ...
  if (ie)
{
  ...
  document.all["main"].innerHTML  = "<font color=\"#99ffff\"><b>"+nCurrentYear+"</b></font>";
  document.all["main2"].innerHTML = "<a href=\"javascript:showMonthMenu()\" style=\"text-decoration:none\"><font color=\"#99ffff\"><b>"+MonthNames[nCurrentMonth-1]+"</b></font></a>\n";
  ...
  while (date.getMonth() == nCurrentMonth-1)
  {
	...
	document.all["idDate"+nDate].style.left = posLeft;
	document.all["idDate"+nDate].style.top  = posTop;
	if (date.getDay() == 0 || date.getDay() == 6)
		document.all["idDate"+nDate].style.color  = "red";
	else
		document.all["idDate"+nDate].style.color  = "black";
	document.all["idDate"+nDate].style.visibility = "visible";
	date = new Date(currentyear, date.getMonth(), date.getDate()+1);
	if (posDay == 6) nWeek++;
  }
  for (++nDate; nDate <= 31; nDate++)
	document.all["idDate"+nDate].style.visibility = "hidden";
}
  if (n)
{
  // Verify parameters
