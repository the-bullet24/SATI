...
<FORM name="f1" action="/sarawebbanking/servlet/DiarioElectronicoServlet">
<CENTER><SPAN style="font-family: Arial; font-size: 9pt"><A
	name="Diario Electronico"></A><B>DIARIO ELECTRÓNICO</B></SPAN><BR>
<BR>
<TABLE width="572" style="font-family: Arial; font-size: 9pt">
  <TBODY>
    <TR>
	  ...
	  <OPTION value="9686">9686 - Pago de Tasas Judiciales con Cargo en Cta. Ahorros MN</OPTION>
	  <OPTION value="9635">9635 - Pago de Tasas Judiciales con Cargo en Cta. Ahorros ME</OPTION>
...
<TABLE border="2" width="600" bgcolor="#ffffff" style="font-family: Arial; font-size: 9pt">
  <TBODY>
	<TR bgcolor="#eacda2">
      ...
      <TH width="5%" bgcolor="#eacda2" align="center">Hora de Operación</TH>
...
for (int pos=0;pos<tjoutra.getGrid().size();pos++){
	...
	<TR>
      ...
      <TD width="12%" align="center" NOWRAP>&nbsp;<%=tjoutra.getNroCuenta()%></TD>
...
<HR width="600">
<FONT color="000000" size="2" face="Arial"><A href="/sarawebbanking/SARAWebManager/DiarioElectronico/DiarioElectronico.jsp#Diario Electronico">subir</A></FONT><BR>
</CENTER>
