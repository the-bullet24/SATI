...
<HTML>
<HEAD> <jsp:useBean id="ctaaho" type="CosapiSoft.SARAWebManager.WAPCtaAho" scope="session"/>
...
<FORM name="f1" action="/sarawebbanking/servlet/WAPCtaAhoServlet">
<DIV align="center"></DIV>
<CENTER><SPAN
	style="font-style: normal; font-family: sans-serif, Arial; font-size: 9pt"><A
	name="WAPConsultasCtasAho"></A><B>CONSULTA DE SALDO CUENTA DE AHORROS MN- CANAL
WAP</B></SPAN><BR>
...
try{
for (int pos=0;pos<ctaaho.getGrid().size();pos++){
    ctaaho.next(pos);%>
    <TR>
      <TD width="10%" align="right"><%out.print(ctaaho.getNrotar());%></TD>
      <TD width="10%" align="center"><%out.print(ctaaho.getNumcta());%></TD>
      <TD width="10%" align="center"><%out.print(ctaaho.getDatpro());%></TD>
      <TD width="10%" align="center"><%out.print(ctaaho.getMsgerror());%></TD>
      <TD width="10%" align="center"><%out.print(ctaaho.getEmpresa());%></TD>
...
<HR width="600">
<A href="#WAPConsultasCtasAho">subir</A><BR>
</CENTER>
