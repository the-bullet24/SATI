...
<TITLE>Log de Operaciones (Builder)</TITLE>
</HEAD>
<BODY background="/sarawebbanking/images/fondo1.JPG" vlink="#0000ff" alink="#0000ff">
<FORM action="/sarawebbanking/servlet/LogDeOperacionesBuilderServlet">
...
<TABLE width="650">
  <TBODY>
    <TR>
      ...
      <% try {
            logBuilder.loadComboUsr();
         } catch(Exception e) {
         }%> 
<%for (int pos2=0;pos2<logBuilder.usuarios.size();pos2++){%>
<%logBuilder.nextUsr(pos2);%>
      <OPTION value="<%= logBuilder.getUsr_nam()%>"> <%out.print(logBuilder.getUsr_nam());%></OPTION>
<%}%>
</SELECT></FONT></TD>
    </TR>
    <TR>
...
<%out.println("<SELECT name=\"Datpro1Day\">");
...
<FONT color="#ff0000" size="2" face="Arial"><I><B><%out.print(logBuilder.getError());%></B></I></FONT>
<HR width="600">
...
<%for (int pos=0;pos<logBuilder.getGrid().size();pos++){%>
<%logBuilder.next(pos);%>
    <TR bgcolor="#ffffff">
      <TD width="10%" align="right" bgcolor="#ffffff"><FONT color="#000000" size="2" face="Arial"><%out.print("<A HREF=" + (char)34 + logBuilder.getUrlLogDeOperaciones() + pos + (char)34 + ">" + (pos+1) + "</A>");%></FONT></TD>
      <TD width="10%" align="center" bgcolor="#ffffff"><FONT color="#000000" size="2" face="Arial"><%out.print(logBuilder.getCodusr());%></FONT></TD>
      <TD width="10%" align="center" bgcolor="#ffffff"><FONT color="#000000" size="2" face="Arial"><%out.print(logBuilder.getDatpro());%></FONT></TD>
      <TD width="10%" align="center" bgcolor="#ffffff"><FONT color="#000000" size="2" face="Arial"><%out.print(logBuilder.getHorpro());%></FONT></TD>
      <TD width="15%" align="center" bgcolor="#ffffff"><FONT color="#000000" size="2" face="Arial"><%out.print(logBuilder.getTxtope());%></FONT></TD>
      <TD width="15%" align="center" bgcolor="#ffffff"><FONT color="#000000" size="2" face="Arial"><%out.print(logBuilder.getTxttab());%></FONT></TD>
    </TR>
<%}%>
 </TBODY>
</TABLE>
<HR width="600">
<FONT color="000000" size="2" face="Arial"><A href="/sarawebbanking/SARAWebBanking/LogDeOperaciones/LogDeOperacionesBuilder.jsp#Log de Operaciones">subir</A></FONT></CENTER>
<!--METADATA type="DynamicData" startspan
<INPUT type="hidden" dynamicelement name="Modulo" valueproperty="logBuilder.modulo">
--><INPUT name="Modulo" type="hidden" value="<%= logBuilder.getModulo() %>"><!--METADATA type="DynamicData" endspan--></FORM>
</BODY>
</HTML>
