...
<FORM name="f1" action="/sarawebbanking/servlet/ExportTablesServlet">
<INPUT type="hidden" name="BtnDis" value="exportar">
<CENTER><SPAN
	style="font-style: normal; font-family: sans-serif, Arial; font-size: 9pt"><A
	name="Consolidado"><B>DISTRIBUCION DE TABLAS</B></A></SPAN>
