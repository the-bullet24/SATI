...
<!--
function focusForm() {
  if(document.f1.TxtCodalt.value==''){
      document.f1.TxtCodalt.focus();
  }
}
//-->
</SCRIPT>
<%try{ %>
<FORM name="f1" action="/sarawebbanking/servlet/FaseTrx1_3Servlet">
...
<TABLE width="500">
  <TBODY>
    ...
    <TR>
      ...
      <TH width="50%" align="left"><FONT color="#0000ff" size="2" face="Arial"><%
  if(ttrafas.getAlt().equals("0")){
     out.println("NO");
  }else{
     out.println("SI");
  }
%></FONT></TH>
    ...
    <TR>
      <TH width="50%" align="right"><FONT color="#000000" size="2" face="Arial">Código de Alternativa : </FONT></TH>
      <TH width="50%" align="left"><FONT color="#000000" size="2" face="Arial"><!--METADATA type="DynamicData" startspan
<INPUT size="5" type="text" maxlength="2" name="TxtCodalt" valueproperty="ttrafas.codalt" dynamicelement>
--><INPUT maxlength="2" name="TxtCodalt" size="5" type="text" value="<%= ttrafas.getCodalt() %>"><!--METADATA type="DynamicData" endspan--></FONT></TH>
    </TR>
  </TBODY>
</TABLE>
