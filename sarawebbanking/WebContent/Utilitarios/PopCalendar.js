...
function PoPCalCreateCalendarInstance()
{
	...
	if (!PopCalInstanceCreated())
	{
		...
		this.shadow = 1 // 0  - don't shadow, 1 - shadow
		...
		this.imgDir = "imagen/" // directory for images ... e.g. var imgDir="/img/"
...
function PopCalConstructCalendar ()
{
	...
	for (var datePointer=1; datePointer<=numDaysInMonth; datePointer++ )
	{
		...
		{//para que no te seleccione las fechas que estan despues de hoy
	...
	//mes y año que se muestra arriba
...
function PopCalAddRegularHolidays()
{
	...
	PopCalAddHoliday(28,7,0,"Independencia del Per" + c_uTilde + "", "Independence of Peru")
